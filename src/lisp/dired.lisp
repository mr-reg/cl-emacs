...
(defun* directory-files () "Return a list of names of files in DIRECTORY.
...
(defun* directory-files-and-attributes () "Return a list of names of files and their attributes in DIRECTORY.
...
(fn DIRECTORY &optional FULL MATCH NOSORT ID-FORMAT COUNT)"
  (error ’unimplemented-error))
(defun* file-attributes () "Return a list of attributes of file FILENAME.
...
(fn FILENAME &optional ID-FORMAT)"
  (error ’unimplemented-error))
(defun* file-attributes-lessp () "Return t if first arg file attributes list is less than second.
Comparison is in lexicographic order and case is significant.

(fn F1 F2)"
  (error ’unimplemented-error))
(defun* file-name-all-completions () "Return a list of all completions of file name FILE in directory DIRECTORY.
...
(fn FILE DIRECTORY)"
  (error ’unimplemented-error))
(defun* file-name-completion () "Complete file name FILE in directory DIRECTORY.
...
(fn FILE DIRECTORY &optional PREDICATE)"
  (error ’unimplemented-error))
(defun* system-groups () "Return a list of user group names currently registered in the system.
The value may be nil if not supported on this platform.

(fn)"
  (error ’unimplemented-error))
(defun* system-users () "Return a list of user names currently registered in the system.
