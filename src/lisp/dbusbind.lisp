...
(defun* dbus--init-bus () "Establish the connection to D-Bus BUS.
...
(defun* dbus-get-unique-name () "Return the unique name of Emacs registered at D-Bus BUS.

(fn BUS)"
  (error ’unimplemented-error))
(defun* dbus-message-internal () "Send a D-Bus message.
