...
(defun* command-remapping ()
  #M"Return the remapping for command COMMAND.
...
(fn COMMAND &optional POSITION KEYMAPS)"
  (error 'unimplemented-error))
(defun* copy-keymap ()
  #M"Return a copy of the keymap KEYMAP.
...
(defun* current-active-maps ()
  #M"Return a list of the currently active keymaps.
...
(defun* current-global-map ()
  #M"Return the current global keymap.

(fn)"
  (error 'unimplemented-error))
(defun* current-local-map ()
  #M"Return current buffer's local keymap, or nil if it has none.
Normally the local keymap is set by the major mode with ‘use-local-map'.

(fn)"
  (error 'unimplemented-error))
(defun* current-minor-mode-maps ()
  #M"Return a list of keymaps for the minor modes of the current buffer.

(fn)"
  (error 'unimplemented-error))
(defun* define-key ()
  #M"In KEYMAP, define key sequence KEY as DEF.
...
(defun* describe-buffer-bindings ()
  #M"Insert the list of all defined keys and their definitions.
...
(defun* describe-vector ()
  #M"Insert a description of contents of VECTOR.
...
(defun* help--describe-vector ()
  #M"Insert in the current buffer a description of the contents of VECTOR.
...
(fn VECTOR PREFIX DESCRIBER PARTIAL SHADOW ENTIRE-MAP MENTION-SHADOW)"
  (error 'unimplemented-error))
(defun* key-binding ()
  #M"Return the binding for command KEY in current keymaps.
...
(defun* key-description ()
  #M"Return a pretty description of key-sequence KEYS.
...
(fn KEYS &optional PREFIX)"
  (error 'unimplemented-error))
(defun* keymap--get-keyelt ()
  #M"Given OBJECT which was found in a slot in a keymap,
...
(fn OBJECT AUTOLOAD)"
  (error 'unimplemented-error))
(defun* keymap-parent ()
  #M"Return the parent keymap of KEYMAP.
If KEYMAP has no parent, return nil.

(fn KEYMAP)"
  (error 'unimplemented-error))
(defun* keymap-prompt ()
  #M"Return the prompt-string of a keymap MAP.
...
(fn MAP)"
  (error 'unimplemented-error))
(defun* keymapp ()
  #M"Return t if OBJECT is a keymap.
...
(fn OBJECT)"
  (error 'unimplemented-error))
(defun* lookup-key ()
  #M"Look up key sequence KEY in KEYMAP.  Return the definition.
...
(fn KEYMAP KEY &optional ACCEPT-DEFAULT)"
  (error 'unimplemented-error))
(defun* make-keymap ()
  #M"Construct and return a new keymap, of the form (keymap CHARTABLE . ALIST).
...
(defun* make-sparse-keymap ()
  #M"Construct and return a new sparse keymap.
...
(fn &optional STRING)"
  (error 'unimplemented-error))
(defun* map-keymap ()
  #M"Call FUNCTION once for each event binding in KEYMAP.
...
(defun* minor-mode-key-binding ()
  #M"Find the visible minor mode bindings of KEY.
...
(fn KEY &optional ACCEPT-DEFAULT)"
  (error 'unimplemented-error))
(defun* set-keymap-parent ()
  #M"Modify KEYMAP to set its parent map to PARENT.
Return PARENT.  PARENT should be nil or another keymap.

(fn KEYMAP PARENT)"
  (error 'unimplemented-error))
(defun* single-key-description ()
  #M"Return a pretty description of a character event KEY.
...
(defun* text-char-description ()
  #M"Return the description of CHARACTER in standard Emacs notation.
...
(fn CHARACTER)"
  (error 'unimplemented-error))
(defun* use-global-map ()
  #M"Select KEYMAP as the global keymap.

(fn KEYMAP)"
  (error 'unimplemented-error))
(defun* use-local-map ()
  #M"Select KEYMAP as the local keymap.
If KEYMAP is nil, that means no local keymap.

(fn KEYMAP)"
  (error 'unimplemented-error))
(defun* where-is-internal ()
  #M"Return list of keys that invoke DEFINITION.
