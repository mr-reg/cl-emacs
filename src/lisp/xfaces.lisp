...
(defun* bitmap-spec-p () "Value is non-nil if OBJECT is a valid bitmap specification.
...
(defun* clear-face-cache () "Clear face caches on all frames.
Optional THOROUGHLY non-nil means try to free unused fonts, too.

(fn &optional THOROUGHLY)"
  (error ’unimplemented-error))
(defun* color-distance () "Return an integer distance between COLOR1 and COLOR2 on FRAME.
...
(fn COLOR1 COLOR2 &optional FRAME METRIC)"
  (error ’unimplemented-error))
(defun* color-gray-p () "Return non-nil if COLOR is a shade of gray (or white or black).
FRAME specifies the frame and thus the display for interpreting COLOR.
If FRAME is nil or omitted, use the selected frame.

(fn COLOR &optional FRAME)"
  (error ’unimplemented-error))
(defun* color-supported-p () "Return non-nil if COLOR can be displayed on FRAME.
...
(fn COLOR &optional FRAME BACKGROUND-P)"
  (error ’unimplemented-error))
(defun* color-values-from-color-spec () "Parse color SPEC as a numeric color and return (RED GREEN BLUE).
...
(fn SPEC)"
  (error ’unimplemented-error))
(defun* display-supports-face-attributes-p () "Return non-nil if all the face attributes in ATTRIBUTES are supported.
...
(fn ATTRIBUTES &optional DISPLAY)"
  (error ’unimplemented-error))
(defun* face-attribute-relative-p () "Check whether a face attribute value is relative.
...
(fn ATTRIBUTE VALUE)"
  (error ’unimplemented-error))
(defun* face-attributes-as-vector () "Return a vector of face attributes corresponding to PLIST.

(fn PLIST)"
  (error ’unimplemented-error))
(defun* face-font () "Return the font name of face FACE, or nil if it is unspecified.
...
(fn FACE &optional FRAME CHARACTER)"
  (error ’unimplemented-error))
(defun* frame--face-hash-table () "Return a hash table of frame-local faces defined on FRAME.
For internal use only.

(fn &optional FRAME)"
  (error ’unimplemented-error))
(defun* internal-copy-lisp-face () "Copy face FROM to TO.
...
(fn FROM TO FRAME NEW-FRAME)"
  (error ’unimplemented-error))
(defun* internal-face-x-get-resource () "Get the value of X resource RESOURCE, class CLASS.
...
(fn RESOURCE CLASS &optional FRAME)"
  (error ’unimplemented-error))
(defun* internal-get-lisp-face-attribute () "Return face attribute KEYWORD of face SYMBOL.
...
(fn SYMBOL KEYWORD &optional FRAME)"
  (error ’unimplemented-error))
(defun* internal-lisp-face-attribute-values () "Return a list of valid discrete values for face attribute ATTR.
Value is nil if ATTR doesn’t have a discrete set of valid values.

(fn ATTR)"
  (error ’unimplemented-error))
(defun* internal-lisp-face-empty-p () "True if FACE has no attribute specified.
If the optional argument FRAME is given, report on face FACE in that frame.
If FRAME is t, report on the defaults for face FACE (for new frames).
If FRAME is omitted or nil, use the selected frame.
...
(fn FACE &optional FRAME)"
  (error ’unimplemented-error))
(defun* internal-lisp-face-equal-p () "True if FACE1 and FACE2 are equal.
...
(fn FACE1 FACE2 &optional FRAME)"
  (error ’unimplemented-error))
(defun* internal-lisp-face-p () "Return non-nil if FACE names a face.
...
(fn FACE &optional FRAME)"
  (error ’unimplemented-error))
(defun* internal-make-lisp-face () "Make FACE, a symbol, a Lisp face with all attributes nil.
...
(fn FACE &optional FRAME)"
  (error ’unimplemented-error))
(defun* internal-merge-in-global-face () "Add attributes from frame-default definition of FACE to FACE on FRAME.
Default face attributes override any local face attributes.

(fn FACE FRAME)"
  (error ’unimplemented-error))
(defun* internal-set-alternative-font-family-alist () "Define alternative font families to try in face font selection.
...
(fn ALIST)"
  (error ’unimplemented-error))
(defun* internal-set-alternative-font-registry-alist () "Define alternative font registries to try in face font selection.
...
(fn ALIST)"
  (error ’unimplemented-error))
(defun* internal-set-font-selection-order () "Set font selection order for face font selection to ORDER.
...
(fn ORDER)"
  (error ’unimplemented-error))
(defun* internal-set-lisp-face-attribute () "Set attribute ATTR of FACE to VALUE.
...
(fn FACE ATTR VALUE &optional FRAME)"
  (error ’unimplemented-error))
(defun* merge-face-attribute () "Return face ATTRIBUTE VALUE1 merged with VALUE2.
...
(fn ATTRIBUTE VALUE1 VALUE2)"
  (error ’unimplemented-error))
(defun* tty-suppress-bold-inverse-default-colors () "Suppress/allow boldness of faces with inverse default colors.
...
(fn SUPPRESS)"
  (error ’unimplemented-error))
(defun* x-family-fonts () "Return a list of available fonts of family FAMILY on FRAME.
...
(fn &optional FAMILY FRAME)"
  (error ’unimplemented-error))
(defun* x-list-fonts () "Return a list of the names of available fonts matching PATTERN.
