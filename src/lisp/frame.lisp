...
(defun* frame--set-was-invisible ()
  #M"Set FRAME's was-invisible flag if WAS-INVISIBLE is non-nil.
This function is for internal use only.

(fn FRAME WAS-INVISIBLE)"
  (error 'unimplemented-error))
(defun* frame-after-make-frame ()
  #M"Mark FRAME as made.
...
(fn FRAME MADE)"
  (error 'unimplemented-error))
(defun* frame-ancestor-p ()
  #M"Return non-nil if ANCESTOR is an ancestor of DESCENDANT.
...
(fn ANCESTOR DESCENDANT)"
  (error 'unimplemented-error))
(defun* frame-bottom-divider-width ()
  #M"Return width (in pixels) of horizontal window dividers on FRAME.

(fn &optional FRAME)"
  (error 'unimplemented-error))
(defun* frame-char-height ()
  #M"Height in pixels of a line in the font in frame FRAME.
...
(defun* frame-char-width ()
  #M"Width in pixels of characters in the font in frame FRAME.
If FRAME is omitted or nil, the selected frame is used.
...
(fn &optional FRAME)"
  (error 'unimplemented-error))
(defun* frame-child-frame-border-width ()
  #M"Return width of FRAME's child-frame border in pixels.
...
(fn &optional FRAME)"
  (error 'unimplemented-error))
(defun* frame-focus ()
  #M"Return the frame to which FRAME's keystrokes are currently being sent.
If FRAME is omitted or nil, the selected frame is used.
...
(fn &optional FRAME)"
  (error 'unimplemented-error))
(defun* frame-fringe-width ()
  #M"Return fringe width of FRAME in pixels.

(fn &optional FRAME)"
  (error 'unimplemented-error))
(defun* frame-internal-border-width ()
  #M"Return width of FRAME's internal border in pixels.

(fn &optional FRAME)"
  (error 'unimplemented-error))
(defun* frame-list ()
  #M"Return a list of all live frames.
The return value does not include any tooltip frame.

(fn)"
  (error 'unimplemented-error))
(defun* frame-live-p ()
  #M"Return non-nil if OBJECT is a frame which has not been deleted.
...
(fn OBJECT)"
  (error 'unimplemented-error))
(defun* frame-native-height ()
  #M"Return FRAME's native height in pixels.
...
(fn &optional FRAME)"
  (error 'unimplemented-error))
(defun* frame-native-width ()
  #M"Return FRAME's native width in pixels.
...
(defun* frame-parameter ()
  #M"Return FRAME's value for parameter PARAMETER.
If FRAME is nil, describe the currently selected frame.

(fn FRAME PARAMETER)"
  (error 'unimplemented-error))
(defun* frame-parameters ()
  #M"Return the parameters-alist of frame FRAME.
...
(fn &optional FRAME)"
  (error 'unimplemented-error))
(defun* frame-parent ()
  #M"Return the parent frame of FRAME.
...
(fn &optional FRAME)"
  (error 'unimplemented-error))
(defun* frame-pointer-visible-p ()
  #M"Return t if the mouse pointer displayed on FRAME is visible.
...
(defun* frame-position ()
  #M"Return top left corner of FRAME in pixels.
...
(fn &optional FRAME)"
  (error 'unimplemented-error))
(defun* frame-right-divider-width ()
  #M"Return width (in pixels) of vertical window dividers on FRAME.

(fn &optional FRAME)"
  (error 'unimplemented-error))
(defun* frame-scale-factor ()
  #M"Return FRAMEs scale factor.
If FRAME is omitted or nil, the selected frame is used.
...
(fn &optional FRAME)"
  (error 'unimplemented-error))
(defun* frame-scroll-bar-height ()
  #M"Return scroll bar height of FRAME in pixels.

(fn &optional FRAME)"
  (error 'unimplemented-error))
(defun* frame-scroll-bar-width ()
  #M"Return scroll bar width of FRAME in pixels.

(fn &optional FRAME)"
  (error 'unimplemented-error))
(defun* frame-text-cols ()
  #M"Return width in columns of FRAME's text area.

(fn &optional FRAME)"
  (error 'unimplemented-error))
(defun* frame-text-height ()
  #M"Return text area height of FRAME in pixels.

(fn &optional FRAME)"
  (error 'unimplemented-error))
(defun* frame-text-lines ()
  #M"Return height in lines of FRAME's text area.

(fn &optional FRAME)"
  (error 'unimplemented-error))
(defun* frame-text-width ()
  #M"Return text area width of FRAME in pixels.

(fn &optional FRAME)"
  (error 'unimplemented-error))
(defun* frame-total-cols ()
  #M"Return number of total columns of FRAME.

(fn &optional FRAME)"
  (error 'unimplemented-error))
(defun* frame-total-lines ()
  #M"Return number of total lines of FRAME.

(fn &optional FRAME)"
  (error 'unimplemented-error))
(defun* frame-visible-p ()
  #M"Return t if FRAME is \"visible\" (actually in use for display).
...
(fn FRAME)"
  (error 'unimplemented-error))
(defun* frame-window-state-change ()
  #M"Return t if FRAME's window state change flag is set, nil otherwise.
FRAME must be a live frame and defaults to the selected one.
...
(fn &optional FRAME)"
  (error 'unimplemented-error))
(defun* framep ()
  #M"Return non-nil if OBJECT is a frame.
Value is:
...
(defun* handle-switch-frame ()
  #M"Handle a switch-frame event EVENT.
...
(fn EVENT)"
  (error 'unimplemented-error))
(defun* iconify-frame ()
  #M"Make the frame FRAME into an icon.
...
(defun* last-nonminibuffer-frame ()
  #M"Return last non-minibuffer frame selected.

(fn)"
  (error 'unimplemented-error))
(defun* lower-frame ()
  #M"Send FRAME to the back, so it is occluded by any frames that overlap it.
...
(defun* make-frame-invisible ()
  #M"Make the frame FRAME invisible.
If omitted, FRAME defaults to the currently selected frame.
On graphical displays, invisible frames are not updated and are
usually not displayed at all, even in a window system's \"taskbar\".
...
(defun* make-frame-visible ()
  #M"Make the frame FRAME visible (assuming it is an X window).
If omitted, FRAME defaults to the currently selected frame.

(fn &optional FRAME)"
  (error 'unimplemented-error))
(defun* make-terminal-frame ()
  #M"Create an additional terminal frame, possibly on another terminal.
...
(defun* modify-frame-parameters ()
  #M"Modify FRAME according to new values of its parameters in ALIST.
...
(defun* mouse-pixel-position ()
  #M"Return a list (FRAME X . Y) giving the current mouse frame and position.
...
(fn)"
  (error 'unimplemented-error))
(defun* next-frame ()
  #M"Return the next frame in the frame list after FRAME.
...
(defun* old-selected-frame ()
  #M"Return the old selected FRAME.
FRAME must be a live frame and defaults to the selected one.
...
(defun* previous-frame ()
  #M"Return the previous frame in the frame list before FRAME.
...
(fn &optional FRAME MINIFRAME)"
  (error 'unimplemented-error))
(defun* raise-frame ()
  #M"Bring FRAME to the front, so it occludes any frames it overlaps.
...
(fn &optional FRAME)"
  (error 'unimplemented-error))
(defun* reconsider-frame-fonts ()
  #M"Recreate FRAME's default font using updated font parameters.
...
(defun* redirect-frame-focus ()
  #M"Arrange for keystrokes typed at FRAME to be sent to FOCUS-FRAME.
...
(defun* selected-frame ()
  #M"Return the frame that is now selected.

(fn)"
  (error 'unimplemented-error))
(defun* set-frame-height ()
  #M"Set text height of frame FRAME to HEIGHT lines.
...
(defun* set-frame-position ()
  #M"Set position of FRAME to (X, Y).
...
(defun* set-frame-size ()
  #M"Set text size of FRAME to WIDTH by HEIGHT, measured in characters.
...
(defun* set-frame-width ()
  #M"Set text width of frame FRAME to WIDTH columns.
...
(fn FRAME WIDTH &optional PRETEND PIXELWISE)"
  (error 'unimplemented-error))
(defun* set-frame-window-state-change ()
  #M"Set FRAME's window state change flag according to ARG.
...
(defun* set-mouse-pixel-position ()
  #M"Move the mouse pointer to pixel position (X,Y) in FRAME.
...
(defun* set-mouse-position ()
  #M"Move the mouse pointer to the center of character cell (X,Y) in FRAME.
...
(defun* tool-bar-pixel-width ()
  #M"Return width in pixels of FRAME's tool bar.
...
(defun* visible-frame-list ()
  #M"Return a list of all frames now \"visible\" (being updated).

(fn)"
  (error 'unimplemented-error))
(defun* window-system ()
  #M"The name of the window system that FRAME is displaying through.
...
(fn &optional FRAME)"
  (error 'unimplemented-error))
(defun* x-focus-frame ()
  #M"Set the input focus to FRAME.
...
(defun* x-get-resource ()
  #M"Return the value of ATTRIBUTE, of class CLASS, from the X defaults database.
...
(defun* x-parse-geometry ()
  #M"Parse a display geometry string STRING.
