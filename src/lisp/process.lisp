...
(defun* continue-process ()
  #M"Continue process PROCESS.  May be process or name of one.
...
(fn &optional PROCESS CURRENT-GROUP)"
  (error 'unimplemented-error))
(defun* delete-process ()
  #M"Delete PROCESS: kill it and forget about it immediately.
...
(fn &optional PROCESS)"
  (error 'unimplemented-error))
(defun* format-network-address ()
  #M"Convert network ADDRESS from internal format to a string.
...
(fn ADDRESS &optional OMIT-PORT)"
  (error 'unimplemented-error))
(defun* get-buffer-process ()
  #M"Return the (or a) live process associated with BUFFER.
...
(fn BUFFER)"
  (error 'unimplemented-error))
(defun* get-process ()
  #M"Return the process named NAME, or nil if there is none.

(fn NAME)"
  (error 'unimplemented-error))
(defun* internal-default-interrupt-process ()
  #M"Default function to interrupt process PROCESS.
It shall be the last element in list ‘interrupt-process-functions'.
See function ‘interrupt-process' for more details on usage.

(fn &optional PROCESS CURRENT-GROUP)"
  (error 'unimplemented-error))
(defun* internal-default-process-filter ()
  #M"Function used as default process filter.
This inserts the process's output into its buffer, if there is one.
Otherwise it discards the output.

(fn PROC TEXT)"
  (error 'unimplemented-error))
(defun* internal-default-process-sentinel ()
  #M"Function used as default sentinel for processes.
This inserts a status message into the process's buffer, if there is one.

(fn PROC MSG)"
  (error 'unimplemented-error))
(defun* internal-default-signal-process ()
  #M"Default function to send PROCESS the signal with code SIGCODE.
...
(fn &optional PROCESS CURRENT-GROUP)"
  (error 'unimplemented-error))
(defun* kill-process ()
  #M"Kill process PROCESS.  May be process or name of one.
See function ‘interrupt-process' for more details on usage.

(fn &optional PROCESS CURRENT-GROUP)"
  (error 'unimplemented-error))
(defun* list-system-processes ()
  #M"Return a list of numerical process IDs of all running processes.
...
(fn)"
  (error 'unimplemented-error))
(defun* make-network-process ()
  #M"Create and return a network server or client process.
...
(fn &rest ARGS)"
  (error 'unimplemented-error))
(defun* make-pipe-process ()
  #M"Create and return a bidirectional pipe process.
...
(fn &rest ARGS)"
  (error 'unimplemented-error))
(defun* make-process ()
  #M"Start a program in a subprocess.  Return the process object for it.
...
(fn &rest ARGS)"
  (error 'unimplemented-error))
(defun* make-serial-process ()
  #M"Create and return a serial port process.
...
(fn &rest ARGS)"
  (error 'unimplemented-error))
(defun* network-interface-info ()
  #M"Return information about network interface named IFNAME.
...
(defun* network-interface-list ()
  #M"Return an alist of all network interfaces and their network address.
...
(fn &optional FULL FAMILY)"
  (error 'unimplemented-error))
(defun* network-lookup-address-info ()
  #M"Look up Internet Protocol (IP) address info of NAME.
...
(fn NAME &optional FAMILY HINT)"
  (error 'unimplemented-error))
(defun* num-processors ()
  #M"Return the number of processors, a positive integer.
...
(defun* process-attributes ()
  #M"Return attributes of the process given by its PID, a number.
...
(defun* process-buffer ()
  #M"Return the buffer PROCESS is associated with.
The default process filter inserts output from PROCESS into this buffer.

(fn PROCESS)"
  (error 'unimplemented-error))
(defun* process-coding-system ()
  #M"Return a cons of coding systems for decoding and encoding of PROCESS.

(fn PROCESS)"
  (error 'unimplemented-error))
(defun* process-command ()
  #M"Return the command that was executed to start PROCESS.
...
(fn PROCESS)"
  (error 'unimplemented-error))
(defun* process-contact ()
  #M"Return the contact info of PROCESS; t for a real child.
...
(fn PROCESS &optional KEY NO-BLOCK)"
  (error 'unimplemented-error))
(defun* process-datagram-address ()
  #M"Get the current datagram address associated with PROCESS.
If PROCESS is a non-blocking network process that hasn't been fully
set up yet, this function will block until socket setup has completed.
...
(defun* process-exit-status ()
  #M"Return the exit status of PROCESS or the signal number that killed it.
If PROCESS has not yet exited or died, return 0.

(fn PROCESS)"
  (error 'unimplemented-error))
(defun* process-filter ()
  #M"Return the filter function of PROCESS.
See ‘set-process-filter' for more info on filter functions.

(fn PROCESS)"
  (error 'unimplemented-error))
(defun* process-id ()
  #M"Return the process id of PROCESS.
...
(defun* process-inherit-coding-system-flag ()
  #M"Return the value of inherit-coding-system flag for PROCESS.
...
(fn PROCESS)"
  (error 'unimplemented-error))
(defun* process-list ()
  #M"Return a list of all processes that are Emacs sub-processes.

(fn)"
  (error 'unimplemented-error))
(defun* process-mark ()
  #M"Return the marker for the end of the last output from PROCESS.

(fn PROCESS)"
  (error 'unimplemented-error))
(defun* process-name ()
  #M"Return the name of PROCESS, as a string.
...
(fn PROCESS)"
  (error 'unimplemented-error))
(defun* process-plist ()
  #M"Return the plist of PROCESS.

(fn PROCESS)"
  (error 'unimplemented-error))
(defun* process-query-on-exit-flag ()
  #M"Return the current value of query-on-exit flag for PROCESS.

(fn PROCESS)"
  (error 'unimplemented-error))
(defun* process-running-child-p ()
  #M"Return non-nil if PROCESS has given control of its terminal to a child.
...
(fn &optional PROCESS)"
  (error 'unimplemented-error))
(defun* process-send-eof ()
  #M"Make PROCESS see end-of-file in its input.
...
(fn &optional PROCESS)"
  (error 'unimplemented-error))
(defun* process-send-region ()
  #M"Send current contents of region as input to PROCESS.
PROCESS may be a process, a buffer, the name of a process or buffer, or
nil, indicating the current buffer's process.
...
(fn PROCESS START END)"
  (error 'unimplemented-error))
(defun* process-send-string ()
  #M"Send PROCESS the contents of STRING as input.
PROCESS may be a process, a buffer, the name of a process or buffer, or
nil, indicating the current buffer's process.
...
(fn PROCESS STRING)"
  (error 'unimplemented-error))
(defun* process-sentinel ()
  #M"Return the sentinel of PROCESS.
See ‘set-process-sentinel' for more info on sentinels.

(fn PROCESS)"
  (error 'unimplemented-error))
(defun* process-status ()
  #M"Return the status of PROCESS.
...
(fn PROCESS)"
  (error 'unimplemented-error))
(defun* process-thread ()
  #M"Return the locking thread of PROCESS.
If PROCESS is unlocked, this function returns nil.

(fn PROCESS)"
  (error 'unimplemented-error))
(defun* process-tty-name ()
  #M"Return the name of the terminal PROCESS uses, or nil if none.
...
(fn PROCESS &optional STREAM)"
  (error 'unimplemented-error))
(defun* process-type ()
  #M"Return the connection type of PROCESS.
...
(fn PROCESS)"
  (error 'unimplemented-error))
(defun* processp ()
  #M"Return t if OBJECT is a process.

(fn OBJECT)"
  (error 'unimplemented-error))
(defun* quit-process ()
  #M"Send QUIT signal to process PROCESS.  May be process or name of one.
See function ‘interrupt-process' for more details on usage.

(fn &optional PROCESS CURRENT-GROUP)"
  (error 'unimplemented-error))
(defun* serial-process-configure ()
  #M"Configure speed, bytesize, etc. of a serial process.
...
(defun* set-network-process-option ()
  #M"For network process PROCESS set option OPTION to value VALUE.
...
(fn PROCESS OPTION VALUE &optional NO-ERROR)"
  (error 'unimplemented-error))
(defun* set-process-buffer ()
  #M"Set buffer associated with PROCESS to BUFFER (a buffer, or nil).
Return BUFFER.

(fn PROCESS BUFFER)"
  (error 'unimplemented-error))
(defun* set-process-coding-system ()
  #M"Set coding systems of PROCESS to DECODING and ENCODING.
DECODING will be used to decode subprocess output and ENCODING to
encode subprocess input.

(fn PROCESS &optional DECODING ENCODING)"
  (error 'unimplemented-error))
(defun* set-process-datagram-address ()
  #M"Set the datagram address for PROCESS to ADDRESS.
...
(fn PROCESS ADDRESS)"
  (error 'unimplemented-error))
(defun* set-process-filter ()
  #M"Give PROCESS the filter function FILTER; nil means default.
...
(defun* set-process-inherit-coding-system-flag ()
  #M"Determine whether buffer of PROCESS will inherit coding-system.
...
(fn PROCESS FLAG)"
  (error 'unimplemented-error))
(defun* set-process-plist ()
  #M"Replace the plist of PROCESS with PLIST.  Return PLIST.

(fn PROCESS PLIST)"
  (error 'unimplemented-error))
(defun* set-process-query-on-exit-flag ()
  #M"Specify if query is needed for PROCESS when Emacs is exited.
...
(fn PROCESS FLAG)"
  (error 'unimplemented-error))
(defun* set-process-sentinel ()
  #M"Give PROCESS the sentinel SENTINEL; nil for default.
The sentinel is called as a function when the process changes state.
It gets two arguments: the process, and a string describing the change.

(fn PROCESS SENTINEL)"
  (error 'unimplemented-error))
(defun* set-process-thread ()
  #M"Set the locking thread of PROCESS to be THREAD.
If THREAD is nil, the process is unlocked.

(fn PROCESS THREAD)"
  (error 'unimplemented-error))
(defun* set-process-window-size ()
  #M"Tell PROCESS that it has logical window size WIDTH by HEIGHT.
...
(fn PROCESS HEIGHT WIDTH)"
  (error 'unimplemented-error))
(defun* signal-names ()
  #M"Return a list of known signal names on this system.

(fn)"
  (error 'unimplemented-error))
(defun* signal-process ()
  #M"Send PROCESS the signal with code SIGCODE.
...
(fn PROCESS SIGCODE &optional REMOTE)"
  (error 'unimplemented-error))
(defun* stop-process ()
  #M"Stop process PROCESS.  May be process or name of one.
See function ‘interrupt-process' for more details on usage.
...
(defun* waiting-for-user-input-p ()
  #M"Return non-nil if Emacs is waiting for input from the user.
