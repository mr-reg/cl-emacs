...
(defun* barf-if-buffer-read-only () "Signal a ‘buffer-read-only’ error if the current buffer is read-only.
...
(defun* buffer-base-buffer () "Return the base buffer of indirect buffer BUFFER.
If BUFFER is not indirect, return nil.
BUFFER defaults to the current buffer.

(fn &optional BUFFER)"
  (error ’unimplemented-error))
(defun* buffer-chars-modified-tick () "Return BUFFER’s character-change tick counter.
...
(fn &optional BUFFER)"
  (error ’unimplemented-error))
(defun* buffer-enable-undo () "Start keeping undo information for buffer BUFFER.
No argument or nil as argument means do this for the current buffer.

(fn &optional BUFFER)"
  (error ’unimplemented-error))
(defun* buffer-file-name () "Return name of file BUFFER is visiting, or nil if none.
No argument or nil as argument means use the current buffer.

(fn &optional BUFFER)"
  (error ’unimplemented-error))
(defun* buffer-list () "Return a list of all live buffers.
...
(fn &optional FRAME)"
  (error ’unimplemented-error))
(defun* buffer-live-p () "Return t if OBJECT is a buffer which has not been killed.
Value is nil if OBJECT is not a buffer or if it has been killed.

(fn OBJECT)"
  (error ’unimplemented-error))
(defun* buffer-local-value () "Return the value of VARIABLE in BUFFER.
If VARIABLE does not have a buffer-local binding in BUFFER, the value
is the default binding of the variable.

(fn VARIABLE BUFFER)"
  (error ’unimplemented-error))
(defun* buffer-local-variables () "Return an alist of variables that are buffer-local in BUFFER.
...
(fn &optional BUFFER)"
  (error ’unimplemented-error))
(defun* buffer-modified-p () "Return non-nil if BUFFER was modified since its file was last read or saved.
No argument or nil as argument means use current buffer as BUFFER.
...
(fn &optional BUFFER)"
  (error ’unimplemented-error))
(defun* buffer-modified-tick () "Return BUFFER’s tick counter, incremented for each change in text.
...
(fn &optional BUFFER)"
  (error ’unimplemented-error))
(defun* buffer-name () "Return the name of BUFFER, as a string.
BUFFER defaults to the current buffer.
Return nil if BUFFER has been killed.

(fn &optional BUFFER)"
  (error ’unimplemented-error))
(defun* buffer-swap-text () "Swap the text between current buffer and BUFFER.
Using this function from ‘save-excursion’ might produce surprising
results, see Info node ‘(elisp)Swapping Text’.

(fn BUFFER)"
  (error ’unimplemented-error))
(defun* bury-buffer-internal () "Move BUFFER to the end of the buffer list.

(fn BUFFER)"
  (error ’unimplemented-error))
(defun* current-buffer () "Return the current buffer as a Lisp object.

(fn)"
  (error ’unimplemented-error))
(defun* delete-all-overlays () "Delete all overlays of BUFFER.
BUFFER omitted or nil means delete all overlays of the current
buffer.

(fn &optional BUFFER)"
  (error ’unimplemented-error))
(defun* delete-overlay () "Delete the overlay OVERLAY from its buffer.

(fn OVERLAY)"
  (error ’unimplemented-error))
(defun* erase-buffer () "Delete the entire contents of the current buffer.
Any narrowing restriction in effect (see ‘narrow-to-region’) is removed,
so the buffer is truly empty after this.

(fn)"
  (error ’unimplemented-error))
(defun* force-mode-line-update () "Force redisplay of the current buffer’s mode line and header line.
...
(fn &optional ALL)"
  (error ’unimplemented-error))
(defun* generate-new-buffer-name () "Return a string that is the name of no existing buffer based on NAME.
...
(fn NAME &optional IGNORE)"
  (error ’unimplemented-error))
(defun* get-buffer () "Return the buffer named BUFFER-OR-NAME.
...
(fn BUFFER-OR-NAME)"
  (error ’unimplemented-error))
(defun* get-buffer-create () "Return the buffer specified by BUFFER-OR-NAME, creating a new one if needed.
...
(fn BUFFER-OR-NAME &optional INHIBIT-BUFFER-HOOKS)"
  (error ’unimplemented-error))
(defun* get-file-buffer () "Return the buffer visiting file FILENAME (a string).
...
(fn FILENAME)"
  (error ’unimplemented-error))
(defun* internal--set-buffer-modified-tick () "Set BUFFER’s tick counter to TICK.
No argument or nil as argument means use current buffer as BUFFER.

(fn TICK &optional BUFFER)"
  (error ’unimplemented-error))
(defun* kill-all-local-variables () "Switch to Fundamental mode by killing current buffer’s local variables.
...
(fn &optional KILL-PERMANENT)"
  (error ’unimplemented-error))
(defun* kill-buffer () "Kill the buffer specified by BUFFER-OR-NAME.
...
(fn &optional BUFFER-OR-NAME)"
  (error ’unimplemented-error))
(defun* make-indirect-buffer () "Create and return an indirect buffer for buffer BASE-BUFFER, named NAME.
...
(fn BASE-BUFFER NAME &optional CLONE INHIBIT-BUFFER-HOOKS)"
  (error ’unimplemented-error))
(defun* make-overlay () "Create a new overlay with range BEG to END in BUFFER and return it.
...
(fn BEG END &optional BUFFER FRONT-ADVANCE REAR-ADVANCE)"
  (error ’unimplemented-error))
(defun* move-overlay () "Set the endpoints of OVERLAY to BEG and END in BUFFER.
...
(fn OVERLAY BEG END &optional BUFFER)"
  (error ’unimplemented-error))
(defun* next-overlay-change () "Return the next position after POS where an overlay starts or ends.
If there are no overlay boundaries from POS to (point-max),
the value is (point-max).

(fn POS)"
  (error ’unimplemented-error))
(defun* other-buffer () "Return most recently selected buffer other than BUFFER.
...
(fn &optional BUFFER VISIBLE-OK FRAME)"
  (error ’unimplemented-error))
(defun* overlay-buffer () "Return the buffer OVERLAY belongs to.
Return nil if OVERLAY has been deleted.

(fn OVERLAY)"
  (error ’unimplemented-error))
(defun* overlay-end () "Return the position at which OVERLAY ends.

(fn OVERLAY)"
  (error ’unimplemented-error))
(defun* overlay-get () "Get the property of overlay OVERLAY with property name PROP.

(fn OVERLAY PROP)"
  (error ’unimplemented-error))
(defun* overlay-lists () "Return a list giving all the overlays of the current buffer.
...
(fn)"
  (error ’unimplemented-error))
(defun* overlay-properties () "Return a list of the properties on OVERLAY.
This is a copy of OVERLAY’s plist; modifying its conses has no effect on
OVERLAY.

(fn OVERLAY)"
  (error ’unimplemented-error))
(defun* overlay-put () "Set one property of overlay OVERLAY: give property PROP value VALUE.
VALUE will be returned.

(fn OVERLAY PROP VALUE)"
  (error ’unimplemented-error))
(defun* overlay-recenter () "Recenter the overlays of the current buffer around position POS.
...
(fn POS)"
  (error ’unimplemented-error))
(defun* overlay-start () "Return the position at which OVERLAY starts.

(fn OVERLAY)"
  (error ’unimplemented-error))
(defun* overlayp () "Return t if OBJECT is an overlay.

(fn OBJECT)"
  (error ’unimplemented-error))
(defun* overlays-at () "Return a list of the overlays that contain the character at POS.
...
(fn POS &optional SORTED)"
  (error ’unimplemented-error))
(defun* overlays-in () "Return a list of the overlays that overlap the region BEG ... END.
...
(fn BEG END)"
  (error ’unimplemented-error))
(defun* previous-overlay-change () "Return the previous position before POS where an overlay starts or ends.
If there are no overlay boundaries from (point-min) to POS,
the value is (point-min).

(fn POS)"
  (error ’unimplemented-error))
(defun* rename-buffer () "Change current buffer’s name to NEWNAME (a string).
...
(fn NEWNAME &optional UNIQUE)"
  (error ’unimplemented-error))
(defun* restore-buffer-modified-p () "Like ‘set-buffer-modified-p’, but doesn’t redisplay buffer’s mode line.
...
(fn FLAG)"
  (error ’unimplemented-error))
(defun* set-buffer () "Make buffer BUFFER-OR-NAME current for editing operations.
...
(fn BUFFER-OR-NAME)"
  (error ’unimplemented-error))
(defun* set-buffer-major-mode () "Set an appropriate major mode for BUFFER.
...
(fn BUFFER)"
  (error ’unimplemented-error))
(defun* set-buffer-modified-p () "Mark current buffer as modified or unmodified according to FLAG.
...
(fn FLAG)"
  (error ’unimplemented-error))
(defun* set-buffer-multibyte () "Set the multibyte flag of the current buffer to FLAG.
