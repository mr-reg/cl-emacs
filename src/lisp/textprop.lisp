...
(defun* add-face-text-property (start end face &optional appendp object) "Add the face property to the text from START to END.
...
(defun* add-text-properties (start end props &optional object) "Add properties to the text from START to END.
...
(fn START END PROPERTIES &optional OBJECT)"
  (error ’unimplemented-error))
(defun* get-char-property () "Return the value of POSITION’s property PROP, in OBJECT.
...
(fn POSITION PROP &optional OBJECT)"
  (error ’unimplemented-error))
(defun* get-char-property-and-overlay () "Like ‘get-char-property’, but with extra overlay information.
...
(fn POSITION PROP &optional OBJECT)"
  (error ’unimplemented-error))
(defun* get-text-property () "Return the value of POSITION’s property PROP, in OBJECT.
...
(fn POSITION PROP &optional OBJECT)"
  (error ’unimplemented-error))
(defun* next-char-property-change () "Return the position of next text property or overlay change.
...
(fn POSITION &optional LIMIT)"
  (error ’unimplemented-error))
(defun* next-property-change () "Return the position of next property change.
...
(fn POSITION &optional OBJECT LIMIT)"
  (error ’unimplemented-error))
(defun* next-single-char-property-change () "Return the position of next text property or overlay change for a specific property.
...
(fn POSITION PROP &optional OBJECT LIMIT)"
  (error ’unimplemented-error))
(defun* next-single-property-change () "Return the position of next property change for a specific property.
Scans characters forward from POSITION till it finds
a change in the PROP property, then returns the position of the change.
If the optional third argument OBJECT is a buffer (or nil, which means
the current buffer), POSITION is a buffer position (integer or marker).
...
(fn POSITION PROP &optional OBJECT LIMIT)"
  (error ’unimplemented-error))
(defun* previous-char-property-change () "Return the position of previous text property or overlay change.
...
(fn POSITION &optional LIMIT)"
  (error ’unimplemented-error))
(defun* previous-property-change () "Return the position of previous property change.
...
(fn POSITION &optional OBJECT LIMIT)"
  (error ’unimplemented-error))
(defun* previous-single-char-property-change () "Return the position of previous text property or overlay change for a specific property.
...
(fn POSITION PROP &optional OBJECT LIMIT)"
  (error ’unimplemented-error))
(defun* previous-single-property-change () "Return the position of previous property change for a specific property.
Scans characters backward from POSITION till it finds
a change in the PROP property, then returns the position of the change.
If the optional third argument OBJECT is a buffer (or nil, which means
the current buffer), POSITION is a buffer position (integer or marker).
...
(fn POSITION PROP &optional OBJECT LIMIT)"
  (error ’unimplemented-error))
(defun* put-text-property (start end prop value &optional object) "Set one property of the text from START to END.
...
(fn START END PROPERTIES &optional OBJECT)"
  (error ’unimplemented-error))
(defun* set-text-properties (start end props &optional object) "Completely replace properties of text from START to END.
...
(fn START END PROPERTIES &optional OBJECT)"
  (error ’unimplemented-error))
(defun* text-properties-at () "Return the list of properties of the character at POSITION in OBJECT.
If the optional second argument OBJECT is a buffer (or nil, which means
the current buffer), POSITION is a buffer position (integer or marker).
...
(fn POSITION &optional OBJECT)"
  (error ’unimplemented-error))
(defun* text-property-any () "Check text from START to END for property PROPERTY equaling VALUE.
...
(fn START END PROPERTY VALUE &optional OBJECT)"
  (error ’unimplemented-error))
(defun* text-property-not-all () "Check text from START to END for property PROPERTY not equaling VALUE.
If so, return the position of the first character whose property PROPERTY
