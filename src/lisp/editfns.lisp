...
(defun* bolp () "Return t if point is at the beginning of a line.

(fn)"
  (error ’unimplemented-error))
(defun* buffer-size () "Return the number of characters in the current buffer.
...
(fn &optional BUFFER)"
  (error ’unimplemented-error))
(defun* buffer-string () "Return the contents of the current buffer as a string.
...
(fn)"
  (error ’unimplemented-error))
(defun* buffer-substring () "Return the contents of part of the current buffer as a string.
...
(fn START END)"
  (error ’unimplemented-error))
(defun* buffer-substring-no-properties () "Return the characters of part of the buffer, without the text properties.
The two arguments START and END are character positions;
they can be in either order.

(fn START END)"
  (error ’unimplemented-error))
(defun* byte-to-position () "Return the character position for byte position BYTEPOS.
If BYTEPOS is out of range, the value is nil.

(fn BYTEPOS)"
  (error ’unimplemented-error))
(defun* byte-to-string () "Convert arg BYTE to a unibyte string containing that byte.

(fn BYTE)"
  (error ’unimplemented-error))
(defun* char-after () "Return character in current buffer at position POS.
POS is an integer or a marker and defaults to point.
If POS is out of range, the value is nil.

(fn &optional POS)"
  (error ’unimplemented-error))
(defun* char-before () "Return character in current buffer preceding position POS.
POS is an integer or a marker and defaults to point.
If POS is out of range, the value is nil.

(fn &optional POS)"
  (error ’unimplemented-error))
(defun* char-equal () "Return t if two characters match, optionally ignoring case.
Both arguments must be characters (i.e. integers).
Case is ignored if ‘case-fold-search’ is non-nil in the current buffer.

(fn C1 C2)"
  (error ’unimplemented-error))
(defun* char-to-string () "Convert arg CHAR to a string containing that character.

(fn CHAR)"
  (error ’unimplemented-error))
(defun* compare-buffer-substrings () "Compare two substrings of two buffers; return result as number.
...
(fn BUFFER1 START1 END1 BUFFER2 START2 END2)"
  (error ’unimplemented-error))
(defun* constrain-to-field () "Return the position closest to NEW-POS that is in the same field as OLD-POS.
...
(fn NEW-POS OLD-POS &optional ESCAPE-FROM-EDGE ONLY-IN-LINE INHIBIT-CAPTURE-PROPERTY)"
  (error ’unimplemented-error))
(defun* current-message () "Return the string currently displayed in the echo area, or nil if none.

(fn)"
  (error ’unimplemented-error))
(defun* delete-and-extract-region () "Delete the text between START and END and return it.

(fn START END)"
  (error ’unimplemented-error))
(defun* delete-field () "Delete the field surrounding POS.
A field is a region of text with the same ‘field’ property.
If POS is nil, the value of point is used for POS.

(fn &optional POS)"
  (error ’unimplemented-error))
(defun* delete-region () "Delete the text between START and END.
If called interactively, delete the region between point and mark.
This command deletes buffer text without modifying the kill ring.

(fn START END)"
  (error ’unimplemented-error))
(defun* emacs-pid () "Return the process ID of Emacs, as an integer.

(fn)"
  (error ’unimplemented-error))
(defun* eobp () "Return t if point is at the end of the buffer.
If the buffer is narrowed, this means the end of the narrowed part.

(fn)"
  (error ’unimplemented-error))
(defun* eolp () "Return t if point is at the end of a line.
‘End of a line’ includes point being at the end of the buffer.

(fn)"
  (error ’unimplemented-error))
(defun* field-beginning () "Return the beginning of the field surrounding POS.
A field is a region of text with the same ‘field’ property.
If POS is nil, the value of point is used for POS.
...
(fn &optional POS ESCAPE-FROM-EDGE LIMIT)"
  (error ’unimplemented-error))
(defun* field-end () "Return the end of the field surrounding POS.
A field is a region of text with the same ‘field’ property.
If POS is nil, the value of point is used for POS.
...
(fn &optional POS ESCAPE-FROM-EDGE LIMIT)"
  (error ’unimplemented-error))
(defun* field-string () "Return the contents of the field surrounding POS as a string.
A field is a region of text with the same ‘field’ property.
If POS is nil, the value of point is used for POS.

(fn &optional POS)"
  (error ’unimplemented-error))
(defun* field-string-no-properties () "Return the contents of the field around POS, without text properties.
A field is a region of text with the same ‘field’ property.
If POS is nil, the value of point is used for POS.

(fn &optional POS)"
  (error ’unimplemented-error))
(defun* following-char () "Return the character following point, as a number.
At the end of the buffer or accessible region, return 0.

(fn)"
  (error ’unimplemented-error))
(defun* format-message () "Format a string out of a format-string and arguments.
...
(fn STRING &rest OBJECTS)"
  (error ’unimplemented-error))
(defun* gap-position () "Return the position of the gap, in the current buffer.
See also ‘gap-size’.

(fn)"
  (error ’unimplemented-error))
(defun* gap-size () "Return the size of the current buffer’s gap.
See also ‘gap-position’.

(fn)"
  (error ’unimplemented-error))
(defun* get-pos-property () "Return the value of POSITION’s property PROP, in OBJECT.
...
(fn POSITION PROP &optional OBJECT)"
  (error ’unimplemented-error))
(defun* goto-char () "Set point to POSITION, a number or marker.
...
(fn POSITION)"
  (error ’unimplemented-error))
(defun* group-gid () "Return the effective gid of Emacs, as an integer.

(fn)"
  (error ’unimplemented-error))
(defun* group-name () "Return the name of the group whose numeric group ID is GID.
The argument GID should be an integer or a float.
Return nil if a group with such GID does not exists or is not known.

(fn GID)"
  (error ’unimplemented-error))
(defun* group-real-gid () "Return the real gid of Emacs, as an integer.

(fn)"
  (error ’unimplemented-error))
(defun* insert () "Insert the arguments, either strings or characters, at point.
...
(fn &rest ARGS)"
  (error ’unimplemented-error))
(defun* insert-and-inherit () "Insert the arguments at point, inheriting properties from adjoining text.
Point and after-insertion markers move forward to end up
 after the inserted text.
Any other markers at the point of insertion remain before the text.
...
(fn &rest ARGS)"
  (error ’unimplemented-error))
(defun* insert-before-markers () "Insert strings or characters at point, relocating markers after the text.
...
(fn &rest ARGS)"
  (error ’unimplemented-error))
(defun* insert-before-markers-and-inherit () "Insert text at point, relocating markers and inheriting properties.
Point and markers move forward to end up after the inserted text.
...
(fn &rest ARGS)"
  (error ’unimplemented-error))
(defun* insert-buffer-substring () "Insert before point a substring of the contents of BUFFER.
...
(fn BUFFER &optional START END)"
  (error ’unimplemented-error))
(defun* insert-byte () "Insert COUNT (second arg) copies of BYTE (first arg).
...
(fn BYTE COUNT &optional INHERIT)"
  (error ’unimplemented-error))
(defun* insert-char () "Insert COUNT copies of CHARACTER.
...
(fn CHARACTER &optional COUNT INHERIT)"
  (error ’unimplemented-error))
(defun* internal--labeled-narrow-to-region () "Restrict editing in this buffer to START-END, and label the restriction with LABEL.

This is an internal function used by ‘with-restriction’.

(fn START END LABEL)"
  (error ’unimplemented-error))
(defun* internal--unlabel-restriction () "If the current restriction is labeled with LABEL, remove its label.

This is an internal function used by ‘without-restriction’.

(fn LABEL)"
  (error ’unimplemented-error))
(defun* line-beginning-position () "Return the position of the first character in the current line/field.
...
(fn &optional N)"
  (error ’unimplemented-error))
(defun* line-end-position () "Return the position of the last character in the current line/field.
...
(fn &optional N)"
  (error ’unimplemented-error))
(defun* mark-marker () "Return this buffer’s mark, as a marker object.
Watch out!  Moving this marker changes the mark position.
If you set the marker not to point anywhere, the buffer will have no mark.

(fn)"
  (error ’unimplemented-error))
(defun* message-box () "Display a message, in a dialog box if possible.
...
(fn FORMAT-STRING &rest ARGS)"
  (error ’unimplemented-error))
(defun* message-or-box () "Display a message in a dialog box or in the echo area.
...
(fn FORMAT-STRING &rest ARGS)"
  (error ’unimplemented-error))
(defun* narrow-to-region () "Restrict editing in this buffer to the current region.
...
(fn START END)"
  (error ’unimplemented-error))
(defun* ngettext () "Return the translation of MSGID (plural MSGID-PLURAL) depending on N.
...
(fn MSGID MSGID-PLURAL N)"
  (error ’unimplemented-error))
(defun* point () "Return value of point, as an integer.
Beginning of buffer is position (point-min).

(fn)"
  (error ’unimplemented-error))
(defun* point-marker () "Return value of point, as a marker object.

(fn)"
  (error ’unimplemented-error))
(defun* point-max () "Return the maximum permissible value of point in the current buffer.
This is (1+ (buffer-size)), unless narrowing (a buffer restriction)
is in effect, in which case it is less.

(fn)"
  (error ’unimplemented-error))
(defun* point-max-marker () "Return a marker to the maximum permissible value of point in this buffer.
This is (1+ (buffer-size)), unless narrowing (a buffer restriction)
is in effect, in which case it is less.

(fn)"
  (error ’unimplemented-error))
(defun* point-min () "Return the minimum permissible value of point in the current buffer.
This is 1, unless narrowing (a buffer restriction) is in effect.

(fn)"
  (error ’unimplemented-error))
(defun* point-min-marker () "Return a marker to the minimum permissible value of point in this buffer.
This is the beginning, unless narrowing (a buffer restriction) is in effect.

(fn)"
  (error ’unimplemented-error))
(defun* pos-bol () "Return the position of the first character on the current line.
...
(fn &optional N)"
  (error ’unimplemented-error))
(defun* pos-eol () "Return the position of the last character on the current line.
With argument N not nil or 1, move forward N - 1 lines first.
If scan reaches end of buffer, return that position.
...
(fn &optional N)"
  (error ’unimplemented-error))
(defun* position-bytes () "Return the byte position for character position POSITION.
If POSITION is out of range, the value is nil.

(fn POSITION)"
  (error ’unimplemented-error))
(defun* preceding-char () "Return the character preceding point, as a number.
...
(fn STRING &rest PROPERTIES)"
  (error ’unimplemented-error))
(defun* region-beginning () "Return the integer value of point or mark, whichever is smaller.

(fn)"
  (error ’unimplemented-error))
(defun* region-end () "Return the integer value of point or mark, whichever is larger.

(fn)"
  (error ’unimplemented-error))
(defun* replace-buffer-contents () "Replace accessible portion of current buffer with that of SOURCE.
...
(fn SOURCE &optional MAX-SECS MAX-COSTS)"
  (error ’unimplemented-error))
(defun* save-current-buffer () "Record which buffer is current; execute BODY; make that buffer current.
BODY is executed just like ‘progn’.

(fn &rest BODY)"
  (error ’unimplemented-error))
(defun* save-excursion () "Save point, and current buffer; execute BODY; restore those things.
...
(fn &rest BODY)"
  (error ’unimplemented-error))
(defun* save-restriction () "Execute BODY, saving and restoring current buffer’s restrictions.
...
(fn &rest BODY)"
  (error ’unimplemented-error))
(defun* string-to-char () "Return the first character in STRING.

(fn STRING)"
  (error ’unimplemented-error))
(defun* subst-char-in-region () "From START to END, replace FROMCHAR with TOCHAR each time it occurs.
...
(fn START END FROMCHAR TOCHAR &optional NOUNDO)"
  (error ’unimplemented-error))
(defun* system-name () "Return the host name of the machine you are running on, as a string.

(fn)"
  (error ’unimplemented-error))
(defun* translate-region-internal () "Internal use only.
...
(fn START END TABLE)"
  (error ’unimplemented-error))
(defun* transpose-regions () "Transpose region STARTR1 to ENDR1 with STARTR2 to ENDR2.
...
(fn STARTR1 ENDR1 STARTR2 ENDR2 &optional LEAVE-MARKERS)"
  (error ’unimplemented-error))
(defun* user-full-name () "Return the full name of the user logged in, as a string.
...
(fn &optional UID)"
  (error ’unimplemented-error))
(defun* user-login-name () "Return the name under which the user logged in, as a string.
...
(fn &optional UID)"
  (error ’unimplemented-error))
(defun* user-real-login-name () "Return the name of the user’s real uid, as a string.
This ignores the environment variables LOGNAME and USER, so it differs from
‘user-login-name’ when running under ‘su’.

(fn)"
  (error ’unimplemented-error))
(defun* user-real-uid () "Return the real uid of Emacs, as an integer.

(fn)"
  (error ’unimplemented-error))
(defun* user-uid () "Return the effective uid of Emacs, as an integer.

(fn)"
  (error ’unimplemented-error))
(defun* widen () "Remove restrictions (narrowing) from current buffer.
