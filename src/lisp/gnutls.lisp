...
(defun* gnutls-boot ()
  #M"Initialize GnuTLS client for process PROC with TYPE+PROPLIST.
...
(fn PROC TYPE PROPLIST)"
  (error 'unimplemented-error))
(defun* gnutls-bye ()
  #M"Terminate current GnuTLS connection for process PROC.
...
(defun* gnutls-ciphers ()
  #M"Return alist of GnuTLS symmetric cipher descriptions as plists.
The alist key is the cipher name.

(fn)"
  (error 'unimplemented-error))
(defun* gnutls-deinit ()
  #M"Deallocate GnuTLS resources associated with process PROC.
See also ‘gnutls-boot'.

(fn PROC)"
  (error 'unimplemented-error))
(defun* gnutls-digests ()
  #M"Return alist of GnuTLS digest-algorithm method descriptions as plists.
...
(fn)"
  (error 'unimplemented-error))
(defun* gnutls-error-fatalp ()
  #M"Return non-nil if ERROR is fatal.
ERROR is an integer or a symbol with an integer ‘gnutls-code' property.
Usage: (gnutls-error-fatalp ERROR)

(fn ERR)"
  (error 'unimplemented-error))
(defun* gnutls-error-string ()
  #M"Return a description of ERROR.
ERROR is an integer or a symbol with an integer ‘gnutls-code' property.

(fn ERROR)"
  (error 'unimplemented-error))
(defun* gnutls-errorp ()
  #M"Return t if ERROR indicates a GnuTLS problem.
ERROR is an integer or a symbol with an integer ‘gnutls-code' property.

(fn ERROR)"
  (error 'unimplemented-error))
(defun* gnutls-format-certificate ()
  #M"Format a X.509 certificate to a string.
...
(fn CERT)"
  (error 'unimplemented-error))
(defun* gnutls-get-initstage ()
  #M"Return the GnuTLS init stage of process PROC.
See also ‘gnutls-boot'.

(fn PROC)"
  (error 'unimplemented-error))
(defun* gnutls-hash-digest ()
  #M"Digest INPUT with DIGEST-METHOD into a unibyte string.
...
(fn DIGEST-METHOD INPUT)"
  (error 'unimplemented-error))
(defun* gnutls-hash-mac ()
  #M"Hash INPUT with HASH-METHOD and KEY into a unibyte string.
...
(fn HASH-METHOD KEY INPUT)"
  (error 'unimplemented-error))
(defun* gnutls-macs ()
  #M"Return alist of GnuTLS mac-algorithm method descriptions as plists.
...
(fn)"
  (error 'unimplemented-error))
(defun* gnutls-peer-status ()
  #M"Describe a GnuTLS PROC peer certificate and any warnings about it.
...
(defun* gnutls-peer-status-warning-describe ()
  #M"Describe the warning of a GnuTLS peer status from ‘gnutls-peer-status'.

(fn STATUS-SYMBOL)"
  (error 'unimplemented-error))
(defun* gnutls-symmetric-decrypt ()
  #M"Decrypt INPUT with symmetric CIPHER, KEY+AEAD_AUTH, and IV to a unibyte string.
...
(fn CIPHER KEY IV INPUT &optional AEAD-AUTH)"
  (error 'unimplemented-error))
(defun* gnutls-symmetric-encrypt ()
  #M"Encrypt INPUT with symmetric CIPHER, KEY+AEAD_AUTH, and IV to a unibyte string.
