...
(defun* image-cache-size ()
  #M"Return the size of the image cache.

(fn)"
  (error 'unimplemented-error))
(defun* image-flush ()
  #M"Flush the image with specification SPEC on frame FRAME.
...
(fn SPEC &optional FRAME)"
  (error 'unimplemented-error))
(defun* image-mask-p ()
  #M"Return t if image SPEC has a mask bitmap.
FRAME is the frame on which the image will be displayed.  FRAME nil
or omitted means use the selected frame.

(fn SPEC &optional FRAME)"
  (error 'unimplemented-error))
(defun* image-metadata ()
  #M"Return metadata for image SPEC.
FRAME is the frame on which the image will be displayed.  FRAME nil
or omitted means use the selected frame.
...
(fn SPEC &optional FRAME)"
  (error 'unimplemented-error))
(defun* image-size ()
  #M"Return the size of image SPEC as pair (WIDTH . HEIGHT).
...
(fn SPEC &optional PIXELS FRAME)"
  (error 'unimplemented-error))
(defun* image-transforms-p ()
  #M"Test whether FRAME supports image transformation.
...
(fn &optional FRAME)"
  (error 'unimplemented-error))
(defun* imagep ()
  #M"Value is non-nil if SPEC is a valid image specification.

(fn SPEC)"
  (error 'unimplemented-error))
(defun* init-image-library ()
  #M"Initialize image library implementing image type TYPE.
