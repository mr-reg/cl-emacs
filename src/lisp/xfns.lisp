...
(defun* x-begin-drag ()
  #M"Begin dragging contents on FRAME, with targets TARGETS.
...
(fn TARGETS &optional ACTION FRAME RETURN-FRAME ALLOW-CURRENT-FRAME FOLLOW-TOOLTIP)"
  (error 'unimplemented-error))
(defun* x-change-window-property ()
  #M"Change window property PROP to VALUE on the X window of FRAME.
...
(fn PROP VALUE &optional FRAME TYPE FORMAT OUTER-P WINDOW-ID)"
  (error 'unimplemented-error))
(defun* x-close-connection ()
  #M"Close the connection to TERMINAL's X server.
...
(fn TERMINAL)"
  (error 'unimplemented-error))
(defun* x-create-frame ()
  #M"Make a new X window, which is called a \"frame\" in Emacs terms.
...
(fn PARMS)"
  (error 'unimplemented-error))
(defun* x-delete-window-property ()
  #M"Remove window property PROP from X window of FRAME.
...
(defun* x-display-backing-store ()
  #M"Return an indication of whether X display TERMINAL does backing store.
...
(defun* x-display-color-cells ()
  #M"Return the number of color cells of the X display TERMINAL.
The optional argument TERMINAL specifies which display to ask about.
TERMINAL should be a terminal object, a frame or a display name (a string).
If omitted or nil, that stands for the selected frame's display.
(On MS Windows, this function does not accept terminal objects.)
...
(fn &optional TERMINAL)"
  (error 'unimplemented-error))
(defun* x-display-grayscale-p ()
  #M"Return t if the X display supports shades of gray.
...
(defun* x-display-list ()
  #M"Return the list of display names that Emacs has connections to.

(fn)"
  (error 'unimplemented-error))
(defun* x-display-mm-height ()
  #M"Return the height in millimeters of the X display TERMINAL.
The optional argument TERMINAL specifies which display to ask about.
TERMINAL should be a terminal object, a frame or a display name (a string).
If omitted or nil, that stands for the selected frame's display.
(On MS Windows, this function does not accept terminal objects.)
...
(defun* x-display-mm-width ()
  #M"Return the width in millimeters of the X display TERMINAL.
The optional argument TERMINAL specifies which display to ask about.
TERMINAL should be a terminal object, a frame or a display name (a string).
If omitted or nil, that stands for the selected frame's display.
(On MS Windows, this function does not accept terminal objects.)
...
(defun* x-display-monitor-attributes-list ()
  #M"Return a list of physical monitor attributes on the X display TERMINAL.
...
(defun* x-display-pixel-height ()
  #M"Return the height in pixels of the X display TERMINAL.
The optional argument TERMINAL specifies which display to ask about.
TERMINAL should be a terminal object, a frame or a display name (a string).
If omitted or nil, that stands for the selected frame's display.
(On MS Windows, this function does not accept terminal objects.)
...
(defun* x-display-pixel-width ()
  #M"Return the width in pixels of the X display TERMINAL.
The optional argument TERMINAL specifies which display to ask about.
TERMINAL should be a terminal object, a frame or a display name (a string).
If omitted or nil, that stands for the selected frame's display.
(On MS Windows, this function does not accept terminal objects.)
...
(defun* x-display-planes ()
  #M"Return the number of bitplanes of the X display TERMINAL.
The optional argument TERMINAL specifies which display to ask about.
TERMINAL should be a terminal object, a frame or a display name (a string).
If omitted or nil, that stands for the selected frame's display.
(On MS Windows, this function does not accept terminal objects.)
...
(defun* x-display-save-under ()
  #M"Return t if the X display TERMINAL supports the save-under feature.
The optional argument TERMINAL specifies which display to ask about.
TERMINAL should be a terminal object, a frame or a display name (a string).
If omitted or nil, that stands for the selected frame's display.
...
(defun* x-display-screens ()
  #M"Return the number of screens on the X server of display TERMINAL.
The optional argument TERMINAL specifies which display to ask about.
TERMINAL should be a terminal object, a frame or a display name (a string).
If omitted or nil, that stands for the selected frame's display.
...
(fn &optional TERMINAL)"
  (error 'unimplemented-error))
(defun* x-display-set-last-user-time ()
  #M"Set the last user time of TERMINAL to TIME-OBJECT.
...
(defun* x-display-visual-class ()
  #M"Return the visual class of the X display TERMINAL.
...
(fn &optional TERMINAL)"
  (error 'unimplemented-error))
(defun* x-double-buffered-p ()
  #M"Return t if FRAME is being double buffered.

(fn &optional FRAME)"
  (error 'unimplemented-error))
(defun* x-export-frames ()
  #M"Return image data of FRAMES in TYPE format.
...
(fn &optional FRAMES TYPE)"
  (error 'unimplemented-error))
(defun* x-frame-edges ()
  #M"Return edge coordinates of FRAME.
...
(fn &optional FRAME TYPE)"
  (error 'unimplemented-error))
(defun* x-frame-geometry ()
  #M"Return geometric attributes of FRAME.
FRAME must be a live frame and defaults to the selected one.  The return
...
(fn &optional FRAME)"
  (error 'unimplemented-error))
(defun* x-frame-list-z-order ()
  #M"Return list of Emacs' frames, in Z (stacking) order.
The optional argument TERMINAL specifies which display to ask about.
...
(fn &optional TERMINAL)"
  (error 'unimplemented-error))
(defun* x-frame-restack ()
  #M"Restack FRAME1 below FRAME2.
...
(fn FRAME1 FRAME2 &optional ABOVE)"
  (error 'unimplemented-error))
(defun* x-get-modifier-masks ()
  #M"Return the X modifier masks corresponding to keyboard modifiers.
...
(fn &optional TERMINAL)"
  (error 'unimplemented-error))
(defun* x-hide-tip ()
  #M"Hide the current tooltip window, if there is any.
Value is t if tooltip was open, nil otherwise.

(fn)"
  (error 'unimplemented-error))
(defun* x-internal-focus-input-context ()
  #M"Focus and set the client window of all focused frames' GTK input context.
...
(defun* x-mouse-absolute-pixel-position ()
  #M"Return absolute position of mouse cursor in pixels.
...
(fn)"
  (error 'unimplemented-error))
(defun* x-open-connection ()
  #M"Open a connection to a display server.
...
(fn DISPLAY &optional XRM-STRING MUST-SUCCEED)"
  (error 'unimplemented-error))
(defun* x-server-input-extension-version ()
  #M"Return the version of the X Input Extension supported by TERMINAL.
...
(fn &optional TERMINAL)"
  (error 'unimplemented-error))
(defun* x-server-max-request-size ()
  #M"Return the maximum request size of the X server of display TERMINAL.
The optional argument TERMINAL specifies which display to ask about.
TERMINAL should be a terminal object, a frame or a display name (a string).
If omitted or nil, that stands for the selected frame's display.
...
(defun* x-server-vendor ()
  #M"Return the \"vendor ID\" string of the GUI software on TERMINAL.
...
(defun* x-server-version ()
  #M"Return the version numbers of the GUI software on TERMINAL.
...
(defun* x-set-mouse-absolute-pixel-position ()
  #M"Move mouse pointer to absolute pixel position (X, Y).
...
(fn X Y)"
  (error 'unimplemented-error))
(defun* x-show-tip ()
  #M"Show STRING in a \"tooltip\" window on frame FRAME.
...
(fn STRING &optional FRAME PARMS TIMEOUT DX DY)"
  (error 'unimplemented-error))
(defun* x-synchronize ()
  #M"If ON is non-nil, report X errors as soon as the erring request is made.
...
(fn ON &optional TERMINAL)"
  (error 'unimplemented-error))
(defun* x-translate-coordinates ()
  #M"Translate coordinates from FRAME.
...
(defun* x-uses-old-gtk-dialog ()
  #M"Return t if the old Gtk+ file selection dialog is used.

(fn)"
  (error 'unimplemented-error))
(defun* x-window-property ()
  #M"Value is the value of window property PROP on FRAME.
...
(fn PROP &optional FRAME TYPE WINDOW-ID DELETE-P VECTOR-RET-P)"
  (error 'unimplemented-error))
(defun* x-window-property-attributes ()
  #M"Retrieve metadata about window property PROP on FRAME.
If FRAME is nil or omitted, use the selected frame.
If WINDOW-ID is non-nil, get the property of that window instead of
...
(fn PROP &optional FRAME WINDOW-ID)"
  (error 'unimplemented-error))
(defun* x-wm-set-size-hint ()
  #M"Send the size hints for frame FRAME to the window manager.
If FRAME is omitted or nil, use the selected frame.
Signal error if FRAME is not an X frame.

(fn &optional FRAME)"
  (error 'unimplemented-error))
(defun* xw-color-defined-p ()
  #M"Internal function called by ‘color-defined-p'.
(Note that the Nextstep version of this function ignores FRAME.)

(fn COLOR &optional FRAME)"
  (error 'unimplemented-error))
(defun* xw-color-values ()
  #M"Internal function called by ‘color-values'.
(Note that the Nextstep version of this function ignores FRAME.)

(fn COLOR &optional FRAME)"
  (error 'unimplemented-error))
(defun* xw-display-color-p ()
  #M"Internal function called by ‘display-color-p'.
