...
(defun* current-window-configuration ()
  #M"Return an object representing the current window configuration of FRAME.
...
(fn &optional FRAME)"
  (error 'unimplemented-error))
(defun* delete-other-windows-internal ()
  #M"Make WINDOW fill its frame.
...
(fn &optional WINDOW ROOT)"
  (error 'unimplemented-error))
(defun* delete-window-internal ()
  #M"Remove WINDOW from its frame.
WINDOW defaults to the selected window.  Return nil.
Signal an error when WINDOW is the only window on its frame.

(fn WINDOW)"
  (error 'unimplemented-error))
(defun* force-window-update ()
  #M"Force all windows to be updated on next redisplay.
...
(defun* frame-first-window ()
  #M"Return the topmost, leftmost live window on FRAME-OR-WINDOW.
...
(fn &optional FRAME-OR-WINDOW)"
  (error 'unimplemented-error))
(defun* frame-old-selected-window ()
  #M"Return old selected window of FRAME.
...
(defun* frame-root-window ()
  #M"Return the root window of FRAME-OR-WINDOW.
If omitted, FRAME-OR-WINDOW defaults to the currently selected frame.
...
(fn &optional FRAME-OR-WINDOW)"
  (error 'unimplemented-error))
(defun* frame-selected-window ()
  #M"Return the selected window of FRAME-OR-WINDOW.
If omitted, FRAME-OR-WINDOW defaults to the currently selected frame.
...
(fn &optional FRAME-OR-WINDOW)"
  (error 'unimplemented-error))
(defun* get-buffer-window ()
  #M"Return a window currently displaying BUFFER-OR-NAME, or nil if none.
...
(defun* minibuffer-selected-window ()
  #M"Return window selected just before minibuffer window was selected.
Return nil if the selected window is not a minibuffer window.

(fn)"
  (error 'unimplemented-error))
(defun* minibuffer-window ()
  #M"Return the minibuffer window for frame FRAME.
If FRAME is omitted or nil, it defaults to the selected frame.

(fn &optional FRAME)"
  (error 'unimplemented-error))
(defun* move-to-window-line ()
  #M"Position point relative to window.
...
(fn ARG)"
  (error 'unimplemented-error))
(defun* next-window ()
  #M"Return live window after WINDOW in the cyclic ordering of windows.
...
(defun* old-selected-window ()
  #M"Return the old selected window.
...
(defun* other-window-for-scrolling ()
  #M"Return the other window for \"other window scroll\" commands.
...
(defun* pos-visible-in-window-p ()
  #M"Return non-nil if position POS is currently on the frame in WINDOW.
WINDOW must be a live window and defaults to the selected one.
...
(defun* previous-window ()
  #M"Return live window before WINDOW in the cyclic ordering of windows.
WINDOW must be a live window and defaults to the selected one.  The
optional arguments MINIBUF and ALL-FRAMES specify the set of windows to
consider.
...
(fn &optional WINDOW MINIBUF ALL-FRAMES)"
  (error 'unimplemented-error))
(defun* recenter ()
  #M"Center point in selected window and maybe redisplay frame.
...
(fn &optional ARG REDISPLAY)"
  (error 'unimplemented-error))
(defun* resize-mini-window-internal ()
  #M"Resize mini window WINDOW.

(fn WINDOW)"
  (error 'unimplemented-error))
(defun* run-window-configuration-change-hook ()
  #M"Run ‘window-configuration-change-hook' for FRAME.
If FRAME is omitted or nil, it defaults to the selected frame.
...
(fn &optional FRAME)"
  (error 'unimplemented-error))
(defun* run-window-scroll-functions ()
  #M"Run ‘window-scroll-functions' for WINDOW.
...
(fn &optional WINDOW)"
  (error 'unimplemented-error))
(defun* scroll-down ()
  #M"Scroll text of selected window down ARG lines.
...
(fn &optional ARG)"
  (error 'unimplemented-error))
(defun* scroll-left ()
  #M"Scroll selected window display ARG columns left.
...
(fn &optional ARG SET-MINIMUM)"
  (error 'unimplemented-error))
(defun* scroll-right ()
  #M"Scroll selected window display ARG columns right.
Default for ARG is window width minus 2.
Value is the total amount of leftward horizontal scrolling in
effect after the change.
If SET-MINIMUM is non-nil, the new scroll amount becomes the
...
(fn &optional ARG SET-MINIMUM)"
  (error 'unimplemented-error))
(defun* scroll-up ()
  #M"Scroll text of selected window upward ARG lines.
...
(fn &optional ARG)"
  (error 'unimplemented-error))
(defun* select-window ()
  #M"Select WINDOW which must be a live window.
...
(fn)"
  (error 'unimplemented-error))
(defun* set-frame-selected-window ()
  #M"Set selected window of FRAME to WINDOW.
...
(fn FRAME WINDOW &optional NORECORD)"
  (error 'unimplemented-error))
(defun* set-window-buffer ()
  #M"Make WINDOW display BUFFER-OR-NAME.
WINDOW must be a live window and defaults to the selected one.
...
(defun* set-window-combination-limit ()
  #M"Set combination limit of window WINDOW to LIMIT; return LIMIT.
...
(defun* set-window-configuration ()
  #M"Set the configuration of windows and buffers as specified by CONFIGURATION.
...
(fn CONFIGURATION &optional DONT-SET-FRAME DONT-SET-MINIWINDOW)"
  (error 'unimplemented-error))
(defun* set-window-dedicated-p ()
  #M"Mark WINDOW as dedicated according to FLAG.
...
(defun* set-window-display-table ()
  #M"Set WINDOW's display-table to TABLE.
WINDOW must be a live window and defaults to the selected one.

(fn WINDOW TABLE)"
  (error 'unimplemented-error))
(defun* set-window-fringes ()
  #M"Set fringes of specified WINDOW.
...
(fn WINDOW LEFT-WIDTH &optional RIGHT-WIDTH OUTSIDE-MARGINS PERSISTENT)"
  (error 'unimplemented-error))
(defun* set-window-hscroll ()
  #M"Set number of columns WINDOW is scrolled from left margin to NCOL.
WINDOW must be a live window and defaults to the selected one.
...
(fn WINDOW NCOL)"
  (error 'unimplemented-error))
(defun* set-window-margins ()
  #M"Set width of marginal areas of window WINDOW.
WINDOW must be a live window and defaults to the selected one.
...
(fn WINDOW LEFT-WIDTH &optional RIGHT-WIDTH)"
  (error 'unimplemented-error))
(defun* set-window-new-normal ()
  #M"Set new normal size of WINDOW to SIZE.
...
(fn WINDOW &optional SIZE)"
  (error 'unimplemented-error))
(defun* set-window-new-pixel ()
  #M"Set new pixel size of WINDOW to SIZE.
WINDOW must be a valid window and defaults to the selected one.
Return SIZE.
...
(fn WINDOW SIZE &optional ADD)"
  (error 'unimplemented-error))
(defun* set-window-new-total ()
  #M"Set new total size of WINDOW to SIZE.
WINDOW must be a valid window and defaults to the selected one.
Return SIZE.
...
(fn WINDOW SIZE &optional ADD)"
  (error 'unimplemented-error))
(defun* set-window-next-buffers ()
  #M"Set WINDOW's next buffers to NEXT-BUFFERS.
WINDOW must be a live window and defaults to the selected one.
NEXT-BUFFERS should be a list of buffers.

(fn WINDOW NEXT-BUFFERS)"
  (error 'unimplemented-error))
(defun* set-window-parameter ()
  #M"Set WINDOW's value of PARAMETER to VALUE.
WINDOW can be any window and defaults to the selected one.
Return VALUE.

(fn WINDOW PARAMETER VALUE)"
  (error 'unimplemented-error))
(defun* set-window-point ()
  #M"Make point value in WINDOW be at position POS in WINDOW's buffer.
WINDOW must be a live window and defaults to the selected one.
Return POS.

(fn WINDOW POS)"
  (error 'unimplemented-error))
(defun* set-window-prev-buffers ()
  #M"Set WINDOW's previous buffers to PREV-BUFFERS.
WINDOW must be a live window and defaults to the selected one.
...
(fn WINDOW PREV-BUFFERS)"
  (error 'unimplemented-error))
(defun* set-window-scroll-bars ()
  #M"Set width and type of scroll bars of specified WINDOW.
WINDOW must specify a live window and defaults to the selected one.
...
(fn WINDOW &optional WIDTH VERTICAL-TYPE HEIGHT HORIZONTAL-TYPE PERSISTENT)"
  (error 'unimplemented-error))
(defun* set-window-start ()
  #M"Make display in WINDOW start at position POS in WINDOW's buffer.
...
(fn WINDOW POS &optional NOFORCE)"
  (error 'unimplemented-error))
(defun* set-window-vscroll ()
  #M"Set amount by which WINDOW should be scrolled vertically to VSCROLL.
...
(fn OLD PIXEL-SIZE SIDE NORMAL-SIZE)"
  (error 'unimplemented-error))
(defun* window-at ()
  #M"Return window containing coordinates X and Y on FRAME.
FRAME must be a live frame and defaults to the selected one.
...
(defun* window-body-height ()
  #M"Return the height of WINDOW's text area.
WINDOW must be a live window and defaults to the selected one.  The
...
(fn &optional WINDOW PIXELWISE)"
  (error 'unimplemented-error))
(defun* window-body-width ()
  #M"Return the width of WINDOW's text area.
WINDOW must be a live window and defaults to the selected one.  The
...
(fn &optional WINDOW PIXELWISE)"
  (error 'unimplemented-error))
(defun* window-bottom-divider-width ()
  #M"Return the width in pixels of WINDOW's bottom divider.
WINDOW must be a live window and defaults to the selected one.

(fn &optional WINDOW)"
  (error 'unimplemented-error))
(defun* window-buffer ()
  #M"Return the buffer displayed in window WINDOW.
If WINDOW is omitted or nil, it defaults to the selected window.
Return nil for an internal window or a deleted window.

(fn &optional WINDOW)"
  (error 'unimplemented-error))
(defun* window-bump-use-time ()
  #M"Mark WINDOW as second most recently used.
...
(fn &optional WINDOW)"
  (error 'unimplemented-error))
(defun* window-combination-limit ()
  #M"Return combination limit of window WINDOW.
WINDOW must be a valid window used in horizontal or vertical combination.
...
(fn WINDOW)"
  (error 'unimplemented-error))
(defun* window-configuration-equal-p ()
  #M"Say whether two window configurations have the same window layout.
This function ignores details such as the values of point and
scrolling positions.

(fn X Y)"
  (error 'unimplemented-error))
(defun* window-configuration-frame ()
  #M"Return the frame that CONFIG, a window-configuration object, is about.

(fn CONFIG)"
  (error 'unimplemented-error))
(defun* window-configuration-p ()
  #M"Return t if OBJECT is a window-configuration object.

(fn OBJECT)"
  (error 'unimplemented-error))
(defun* window-dedicated-p ()
  #M"Return non-nil when WINDOW is dedicated to its buffer.
...
(fn &optional WINDOW)"
  (error 'unimplemented-error))
(defun* window-display-table ()
  #M"Return the display-table that WINDOW is using.
WINDOW must be a live window and defaults to the selected one.

(fn &optional WINDOW)"
  (error 'unimplemented-error))
(defun* window-end ()
  #M"Return position at which display currently ends in WINDOW.
...
(fn &optional WINDOW UPDATE)"
  (error 'unimplemented-error))
(defun* window-frame ()
  #M"Return the frame that window WINDOW is on.
WINDOW must be a valid window and defaults to the selected one.

(fn &optional WINDOW)"
  (error 'unimplemented-error))
(defun* window-fringes ()
  #M"Return fringe settings for specified WINDOW.
WINDOW must be a live window and defaults to the selected one.
...
(defun* window-header-line-height ()
  #M"Return the height in pixels of WINDOW's header-line.
WINDOW must be a live window and defaults to the selected one.

(fn &optional WINDOW)"
  (error 'unimplemented-error))
(defun* window-hscroll ()
  #M"Return the number of columns by which WINDOW is scrolled from left margin.
WINDOW must be a live window and defaults to the selected one.

(fn &optional WINDOW)"
  (error 'unimplemented-error))
(defun* window-left-child ()
  #M"Return the leftmost child window of window WINDOW.
WINDOW must be a valid window and defaults to the selected one.
...
(fn &optional WINDOW)"
  (error 'unimplemented-error))
(defun* window-left-column ()
  #M"Return left column of window WINDOW.
...
(defun* window-line-height ()
  #M"Return height in pixels of text line LINE in window WINDOW.
WINDOW must be a live window and defaults to the selected one.
...
(fn &optional LINE WINDOW)"
  (error 'unimplemented-error))
(defun* window-lines-pixel-dimensions ()
  #M"Return pixel dimensions of WINDOW's lines.
...
(fn &optional WINDOW FIRST LAST BODY INVERSE LEFT)"
  (error 'unimplemented-error))
(defun* window-list ()
  #M"Return a list of windows on FRAME, starting with WINDOW.
...
(fn &optional FRAME MINIBUF WINDOW)"
  (error 'unimplemented-error))
(defun* window-list-1 ()
  #M"Return a list of all live windows.
...
(fn &optional WINDOW MINIBUF ALL-FRAMES)"
  (error 'unimplemented-error))
(defun* window-live-p ()
  #M"Return t if OBJECT is a live window and nil otherwise.
A live window is a window that displays a buffer.
Internal windows and deleted windows are not live.

(fn OBJECT)"
  (error 'unimplemented-error))
(defun* window-margins ()
  #M"Get width of marginal areas of window WINDOW.
WINDOW must be a live window and defaults to the selected one.
...
(fn &optional WINDOW)"
  (error 'unimplemented-error))
(defun* window-minibuffer-p ()
  #M"Return t if WINDOW is a minibuffer window.
WINDOW must be a valid window and defaults to the selected one.

(fn &optional WINDOW)"
  (error 'unimplemented-error))
(defun* window-mode-line-height ()
  #M"Return the height in pixels of WINDOW's mode-line.
WINDOW must be a live window and defaults to the selected one.

(fn &optional WINDOW)"
  (error 'unimplemented-error))
(defun* window-new-normal ()
  #M"Return new normal size of window WINDOW.
WINDOW must be a valid window and defaults to the selected one.
...
(fn &optional WINDOW)"
  (error 'unimplemented-error))
(defun* window-new-pixel ()
  #M"Return new pixel size of window WINDOW.
WINDOW must be a valid window and defaults to the selected one.
...
(fn &optional WINDOW)"
  (error 'unimplemented-error))
(defun* window-new-total ()
  #M"Return the new total size of window WINDOW.
WINDOW must be a valid window and defaults to the selected one.
...
(fn &optional WINDOW)"
  (error 'unimplemented-error))
(defun* window-next-buffers ()
  #M"Return list of buffers recently re-shown in WINDOW.
WINDOW must be a live window and defaults to the selected one.

(fn &optional WINDOW)"
  (error 'unimplemented-error))
(defun* window-next-sibling ()
  #M"Return the next sibling window of window WINDOW.
WINDOW must be a valid window and defaults to the selected one.
Return nil if WINDOW has no next sibling.

(fn &optional WINDOW)"
  (error 'unimplemented-error))
(defun* window-normal-size ()
  #M"Return the normal height of window WINDOW.
WINDOW must be a valid window and defaults to the selected one.
...
(defun* window-old-body-pixel-height ()
  #M"Return old height of WINDOW's text area in pixels.
WINDOW must be a live window and defaults to the selected one.
...
(defun* window-old-body-pixel-width ()
  #M"Return old width of WINDOW's text area in pixels.
WINDOW must be a live window and defaults to the selected one.
...
(fn &optional WINDOW)"
  (error 'unimplemented-error))
(defun* window-old-buffer ()
  #M"Return the old buffer displayed by WINDOW.
WINDOW must be a live window and defaults to the selected one.
...
(fn &optional WINDOW)"
  (error 'unimplemented-error))
(defun* window-old-pixel-height ()
  #M"Return old total pixel height of WINDOW.
WINDOW must be a valid window and defaults to the selected one.
...
(fn &optional WINDOW)"
  (error 'unimplemented-error))
(defun* window-old-pixel-width ()
  #M"Return old total pixel width of WINDOW.
WINDOW must be a valid window and defaults to the selected one.
...
(fn &optional WINDOW)"
  (error 'unimplemented-error))
(defun* window-old-point ()
  #M"Return old value of point in WINDOW.
WINDOW must be a live window and defaults to the selected one.

(fn &optional WINDOW)"
  (error 'unimplemented-error))
(defun* window-parameter ()
  #M"Return WINDOW's value for PARAMETER.
WINDOW can be any window and defaults to the selected one.

(fn WINDOW PARAMETER)"
  (error 'unimplemented-error))
(defun* window-parameters ()
  #M"Return the parameters of WINDOW and their values.
...
(fn &optional WINDOW)"
  (error 'unimplemented-error))
(defun* window-parent ()
  #M"Return the parent window of window WINDOW.
WINDOW must be a valid window and defaults to the selected one.
Return nil for a window with no parent (e.g. a root window).

(fn &optional WINDOW)"
  (error 'unimplemented-error))
(defun* window-pixel-height ()
  #M"Return the height of window WINDOW in pixels.
WINDOW must be a valid window and defaults to the selected one.
...
(fn &optional WINDOW)"
  (error 'unimplemented-error))
(defun* window-pixel-left ()
  #M"Return left pixel edge of window WINDOW.
WINDOW must be a valid window and defaults to the selected one.

(fn &optional WINDOW)"
  (error 'unimplemented-error))
(defun* window-pixel-top ()
  #M"Return top pixel edge of window WINDOW.
WINDOW must be a valid window and defaults to the selected one.

(fn &optional WINDOW)"
  (error 'unimplemented-error))
(defun* window-pixel-width ()
  #M"Return the width of window WINDOW in pixels.
WINDOW must be a valid window and defaults to the selected one.
...
(fn &optional WINDOW)"
  (error 'unimplemented-error))
(defun* window-point ()
  #M"Return current value of point in WINDOW.
WINDOW must be a live window and defaults to the selected one.
...
(fn &optional WINDOW)"
  (error 'unimplemented-error))
(defun* window-prev-buffers ()
  #M"Return buffers previously shown in WINDOW.
WINDOW must be a live window and defaults to the selected one.
...
(fn &optional WINDOW)"
  (error 'unimplemented-error))
(defun* window-prev-sibling ()
  #M"Return the previous sibling window of window WINDOW.
WINDOW must be a valid window and defaults to the selected one.
Return nil if WINDOW has no previous sibling.

(fn &optional WINDOW)"
  (error 'unimplemented-error))
(defun* window-resize-apply ()
  #M"Apply requested size values for window-tree of FRAME.
If FRAME is omitted or nil, it defaults to the selected frame.
...
(fn &optional FRAME HORIZONTAL)"
  (error 'unimplemented-error))
(defun* window-resize-apply-total ()
  #M"Apply requested total size values for window-tree of FRAME.
If FRAME is omitted or nil, it defaults to the selected frame.
...
(defun* window-right-divider-width ()
  #M"Return the width in pixels of WINDOW's right divider.
WINDOW must be a live window and defaults to the selected one.

(fn &optional WINDOW)"
  (error 'unimplemented-error))
(defun* window-scroll-bar-height ()
  #M"Return the height in pixels of WINDOW's horizontal scrollbar.
WINDOW must be a live window and defaults to the selected one.

(fn &optional WINDOW)"
  (error 'unimplemented-error))
(defun* window-scroll-bar-width ()
  #M"Return the width in pixels of WINDOW's vertical scrollbar.
WINDOW must be a live window and defaults to the selected one.

(fn &optional WINDOW)"
  (error 'unimplemented-error))
(defun* window-scroll-bars ()
  #M"Get width and type of scroll bars of window WINDOW.
WINDOW must be a live window and defaults to the selected one.
...
(fn &optional WINDOW)"
  (error 'unimplemented-error))
(defun* window-start ()
  #M"Return position at which display currently starts in WINDOW.
WINDOW must be a live window and defaults to the selected one.
This is updated by redisplay or by calling ‘set-window-start'.

(fn &optional WINDOW)"
  (error 'unimplemented-error))
(defun* window-tab-line-height ()
  #M"Return the height in pixels of WINDOW's tab-line.
WINDOW must be a live window and defaults to the selected one.

(fn &optional WINDOW)"
  (error 'unimplemented-error))
(defun* window-text-height ()
  #M"Return the height in lines of the text display area of WINDOW.
WINDOW must be a live window and defaults to the selected one.
...
(fn &optional WINDOW PIXELWISE)"
  (error 'unimplemented-error))
(defun* window-text-width ()
  #M"Return the width in columns of the text display area of WINDOW.
WINDOW must be a live window and defaults to the selected one.
...
(fn &optional WINDOW PIXELWISE)"
  (error 'unimplemented-error))
(defun* window-top-child ()
  #M"Return the topmost child window of window WINDOW.
WINDOW must be a valid window and defaults to the selected one.
Return nil if WINDOW is a live window (live windows have no children).
Return nil if WINDOW is an internal window whose children form a
...
(defun* window-top-line ()
  #M"Return top line of window WINDOW.
...
(fn &optional WINDOW)"
  (error 'unimplemented-error))
(defun* window-total-height ()
  #M"Return the height of window WINDOW in lines.
WINDOW must be a valid window and defaults to the selected one.
...
(fn &optional WINDOW ROUND)"
  (error 'unimplemented-error))
(defun* window-total-width ()
  #M"Return the total width of window WINDOW in columns.
WINDOW must be a valid window and defaults to the selected one.
...
(fn &optional WINDOW ROUND)"
  (error 'unimplemented-error))
(defun* window-use-time ()
  #M"Return the use time of window WINDOW.
WINDOW must specify a live window and defaults to the selected one.
...
(defun* window-valid-p ()
  #M"Return t if OBJECT is a valid window and nil otherwise.
...
(fn OBJECT)"
  (error 'unimplemented-error))
(defun* window-vscroll ()
  #M"Return the amount by which WINDOW is scrolled vertically.
This takes effect when displaying tall lines or images.
...
(fn &optional WINDOW PIXELS-P)"
  (error 'unimplemented-error))
(defun* windowp ()
  #M"Return t if OBJECT is a window and nil otherwise.
