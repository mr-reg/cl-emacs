...
(defun* documentation ()
  #M"Return the documentation string of FUNCTION.
Unless a non-nil second argument RAW is given, the
string is passed through ‘substitute-command-keys'.

(fn FUNCTION &optional RAW)"
  (error 'unimplemented-error))
(defun* documentation-property ()
  #M"Return the documentation string that is SYMBOL's PROP property.
...
(defun* text-quoting-style ()
  #M"Return the current effective text quoting style.
