...
(defun* access-file () "Access file FILENAME, and get an error if that does not work.
The second argument STRING is prepended to the error message.
If there is no error, returns nil.

(fn FILENAME STRING)"
  (error ’unimplemented-error))
(defun* add-name-to-file () "Give FILE additional name NEWNAME.  Both args must be strings.
...
(fn FILE NEWNAME &optional OK-IF-ALREADY-EXISTS)"
  (error ’unimplemented-error))
(defun* car-less-than-car () "Return t if (car A) is numerically less than (car B).

(fn A B)"
  (error ’unimplemented-error))
(defun* clear-buffer-auto-save-failure () "Clear any record of a recent auto-save failure in the current buffer.

(fn)"
  (error ’unimplemented-error))
(defun* copy-file () "Copy FILE to NEWNAME.  Both args must be strings.
...
(fn FILE NEWNAME &optional OK-IF-ALREADY-EXISTS KEEP-TIME PRESERVE-UID-GID PRESERVE-PERMISSIONS)"
  (error ’unimplemented-error))
(defun* default-file-modes () "Return the default file protection for created files.
The value is an integer.

(fn)"
  (error ’unimplemented-error))
(defun* delete-directory-internal () "Delete the directory named DIRECTORY.  Does not follow symlinks.

(fn DIRECTORY)"
  (error ’unimplemented-error))
(defun* delete-file () "Delete file named FILENAME.  If it is a symlink, remove the symlink.
...
(fn FILENAME &optional TRASH)"
  (error ’unimplemented-error))
(defun* directory-file-name () "Returns the file name of the directory named DIRECTORY.
...
(fn DIRECTORY)"
  (error ’unimplemented-error))
(defun* directory-name-p () "Return non-nil if NAME ends with a directory separator character.

(fn NAME)"
  (error ’unimplemented-error))
(defun* do-auto-save () "Auto-save all buffers that need it.
...
(fn &optional NO-MESSAGE CURRENT-ONLY)"
  (error ’unimplemented-error))
(defun* expand-file-name () "Convert filename NAME to absolute, and canonicalize it.
...
(fn NAME &optional DEFAULT-DIRECTORY)"
  (error ’unimplemented-error))
(defun* file-accessible-directory-p () "Return t if FILENAME names a directory you can open.
...
(fn FILENAME)"
  (error ’unimplemented-error))
(defun* file-acl () "Return ACL entries of file named FILENAME.
...
(fn FILENAME)"
  (error ’unimplemented-error))
(defun* file-directory-p () "Return t if FILENAME names an existing directory.
...
(fn FILENAME)"
  (error ’unimplemented-error))
(defun* file-executable-p () "Return t if FILENAME can be executed by you.
...
(fn FILENAME)"
  (error ’unimplemented-error))
(defun* file-exists-p () "Return t if file FILENAME exists (whether or not you can read it).
...
(fn FILENAME)"
  (error ’unimplemented-error))
(defun* file-modes () "Return mode bits of file named FILENAME, as an integer.
...
(fn FILENAME &optional FLAG)"
  (error ’unimplemented-error))
(defun* file-name-absolute-p () "Return t if FILENAME is an absolute file name.
...
(fn FILENAME)"
  (error ’unimplemented-error))
(defun* file-name-as-directory () "Return a string representing the file name FILE interpreted as a directory.
This operation exists because a directory is also a file, but its name as
a directory is different from its name as a file.
...
(fn FILE)"
  (error ’unimplemented-error))
(defun* file-name-case-insensitive-p () "Return t if file FILENAME is on a case-insensitive filesystem.
...
(fn FILENAME)"
  (error ’unimplemented-error))
(defun* file-name-concat () "Append COMPONENTS to DIRECTORY and return the resulting string.
...
(fn DIRECTORY &rest COMPONENTS)"
  (error ’unimplemented-error))
(defun* file-name-directory () "Return the directory component in file name FILENAME.
...
(fn FILENAME)"
  (error ’unimplemented-error))
(defun* file-name-nondirectory () "Return file name FILENAME sans its directory.
...
(fn FILENAME)"
  (error ’unimplemented-error))
(defun* file-newer-than-file-p () "Return t if file FILE1 is newer than file FILE2.
If FILE1 does not exist, the answer is nil;
otherwise, if FILE2 does not exist, the answer is t.

(fn FILE1 FILE2)"
  (error ’unimplemented-error))
(defun* file-readable-p () "Return t if file FILENAME exists and you can read it.
See also ‘file-exists-p’ and ‘file-attributes’.

(fn FILENAME)"
  (error ’unimplemented-error))
(defun* file-regular-p () "Return t if FILENAME names a regular file.
...
(fn FILENAME)"
  (error ’unimplemented-error))
(defun* file-selinux-context () "Return SELinux context of file named FILENAME.
...
(fn FILENAME)"
  (error ’unimplemented-error))
(defun* file-symlink-p () "Return non-nil if file FILENAME is the name of a symbolic link.
...
(fn FILENAME)"
  (error ’unimplemented-error))
(defun* file-system-info () "Return storage information about the file system FILENAME is on.
...
(fn FILENAME)"
  (error ’unimplemented-error))
(defun* file-writable-p () "Return t if file FILENAME can be written or created by you.

(fn FILENAME)"
  (error ’unimplemented-error))
(defun* find-file-name-handler () "Return FILENAME’s handler function for OPERATION, if it has one.
...
(fn FILENAME OPERATION)"
  (error ’unimplemented-error))
(defun* insert-file-contents () "Insert contents of file FILENAME after point.
...
(fn FILENAME &optional VISIT BEG END REPLACE)"
  (error ’unimplemented-error))
(defun* make-directory-internal () "Create a new directory named DIRECTORY.

(fn DIRECTORY)"
  (error ’unimplemented-error))
(defun* make-symbolic-link () "Make a symbolic link to TARGET, named LINKNAME.
...
(fn TARGET LINKNAME &optional OK-IF-ALREADY-EXISTS)"
  (error ’unimplemented-error))
(defun* make-temp-file-internal () "Generate a new file whose name starts with PREFIX, a string.
...
(fn PREFIX DIR-FLAG SUFFIX TEXT)"
  (error ’unimplemented-error))
(defun* make-temp-name () "Generate temporary file name (string) starting with PREFIX (a string).
...
(fn PREFIX)"
  (error ’unimplemented-error))
(defun* next-read-file-uses-dialog-p () "Return t if a call to ‘read-file-name’ will use a dialog.
The return value is only relevant for a call to ‘read-file-name’ that happens
before any other event (mouse or keypress) is handled.

(fn)"
  (error ’unimplemented-error))
(defun* recent-auto-save-p () "Return t if current buffer has been auto-saved recently.
...
(fn)"
  (error ’unimplemented-error))
(defun* rename-file () "Rename FILE as NEWNAME.  Both args must be strings.
...
(fn FILE NEWNAME &optional OK-IF-ALREADY-EXISTS)"
  (error ’unimplemented-error))
(defun* set-binary-mode () "Switch STREAM to binary I/O mode or text I/O mode.
...
(fn STREAM MODE)"
  (error ’unimplemented-error))
(defun* set-buffer-auto-saved () "Mark current buffer as auto-saved with its current text.
No auto-save file will be written until the buffer changes again.

(fn)"
  (error ’unimplemented-error))
(defun* set-default-file-modes () "Set the file permission bits for newly created files.
...
(fn MODE)"
  (error ’unimplemented-error))
(defun* set-file-acl () "Set ACL of file named FILENAME to ACL-STRING.
...
(fn FILENAME ACL-STRING)"
  (error ’unimplemented-error))
(defun* set-file-modes () "Set mode bits of file named FILENAME to MODE (an integer).
...
(fn FILENAME MODE &optional FLAG)"
  (error ’unimplemented-error))
(defun* set-file-selinux-context () "Set SELinux context of file named FILENAME to CONTEXT.
...
(fn FILENAME CONTEXT)"
  (error ’unimplemented-error))
(defun* set-file-times () "Set times of file FILENAME to TIMESTAMP.
...
(fn FILENAME &optional TIMESTAMP FLAG)"
  (error ’unimplemented-error))
(defun* set-visited-file-modtime () "Update buffer’s recorded modification time from the visited file’s time.
...
(fn &optional TIME-FLAG)"
  (error ’unimplemented-error))
(defun* substitute-in-file-name () "Substitute environment variables referred to in FILENAME.
...
(fn FILENAME)"
  (error ’unimplemented-error))
(defun* unhandled-file-name-directory () "Return a directly usable directory name somehow associated with FILENAME.
...
(fn FILENAME)"
  (error ’unimplemented-error))
(defun* unix-sync () "Tell Unix to finish all pending disk updates.

(fn)"
  (error ’unimplemented-error))
(defun* verify-visited-file-modtime () "Return t if last mod time of BUF’s visited file matches what BUF records.
...
(fn &optional BUF)"
  (error ’unimplemented-error))
(defun* visited-file-modtime () "Return the current buffer’s recorded visited file modification time.
...
(fn)"
  (error ’unimplemented-error))
(defun* write-region () "Write current region into specified file.
