...
(defun* char-width ()
  #M"Return width of CHAR when displayed in the current buffer.
...
(fn CHAR)"
  (error 'unimplemented-error))
(defun* characterp ()
  #M"Return non-nil if OBJECT is a character.
...
(fn OBJECT)"
  (error 'unimplemented-error))
(defun* get-byte ()
  #M"Return a byte value of a character at point.
...
(fn &optional POSITION STRING)"
  (error 'unimplemented-error))
(defun* max-char ()
  #M"Return the maximum character code.
...
(defun* multibyte-char-to-unibyte ()
  #M"Convert the multibyte character CH to a byte.
If the multibyte character does not represent a byte, return -1.

(fn CH)"
  (error 'unimplemented-error))
(defun* string ()
  #M"Concatenate all the argument characters and make the result a string.

(fn &rest CHARACTERS)"
  (error 'unimplemented-error))
(defun* string-width ()
  #M"Return width of STRING when displayed in the current buffer.
...
(defun* unibyte-char-to-multibyte ()
  #M"Convert the byte CH to multibyte character.

(fn CH)"
  (error 'unimplemented-error))
(defun* unibyte-string ()
  #M"Concatenate all the argument bytes and make the result a unibyte string.
