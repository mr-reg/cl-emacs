...
(defun* check-coding-system () "Check validity of CODING-SYSTEM.
...
(defun* check-coding-systems-region () "Check if text between START and END is encodable by CODING-SYSTEM-LIST.
...
(fn START END CODING-SYSTEM-LIST)"
  (error ’unimplemented-error))
(defun* coding-system-aliases () "Return the list of aliases of CODING-SYSTEM.

(fn CODING-SYSTEM)"
  (error ’unimplemented-error))
(defun* coding-system-base () "Return the base of CODING-SYSTEM.
Any alias or subsidiary coding system is not a base coding system.

(fn CODING-SYSTEM)"
  (error ’unimplemented-error))
(defun* coding-system-eol-type () "Return eol-type of CODING-SYSTEM.
...
(fn CODING-SYSTEM)"
  (error ’unimplemented-error))
(defun* coding-system-p () "Return t if OBJECT is nil or a coding-system.
See the documentation of ‘define-coding-system’ for information
about coding-system objects.

(fn OBJECT)"
  (error ’unimplemented-error))
(defun* coding-system-plist () "Return the property list of CODING-SYSTEM.

(fn CODING-SYSTEM)"
  (error ’unimplemented-error))
(defun* coding-system-priority-list () "Return a list of coding systems ordered by their priorities.
...
(fn &optional HIGHESTP)"
  (error ’unimplemented-error))
(defun* coding-system-put () "Change value of CODING-SYSTEM’s property PROP to VAL.
...
(fn CODING-SYSTEM PROP VAL)"
  (error ’unimplemented-error))
(defun* decode-big5-char () "Decode a Big5 character which has CODE in BIG5 coding system.
Return the corresponding character.

(fn CODE)"
  (error ’unimplemented-error))
(defun* decode-coding-region () "Decode the current region using the specified coding system.
...
(fn START END CODING-SYSTEM &optional DESTINATION)"
  (error ’unimplemented-error))
(defun* decode-coding-string () "Decode STRING which is encoded in CODING-SYSTEM, and return the result.
...
(fn STRING CODING-SYSTEM &optional NOCOPY BUFFER)"
  (error ’unimplemented-error))
(defun* decode-sjis-char () "Decode a Japanese character which has CODE in shift_jis encoding.
Return the corresponding character.

(fn CODE)"
  (error ’unimplemented-error))
(defun* define-coding-system-alias () "Define ALIAS as an alias for CODING-SYSTEM.

(fn ALIAS CODING-SYSTEM)"
  (error ’unimplemented-error))
(defun* define-coding-system-internal () "For internal use only.

(fn ...)"
  (error ’unimplemented-error))
(defun* detect-coding-region () "Detect coding system of the text in the region between START and END.
...
(fn START END &optional HIGHEST)"
  (error ’unimplemented-error))
(defun* detect-coding-string () "Detect coding system of the text in STRING.
Return a list of possible coding systems ordered by priority.
The coding systems to try and their priorities follows what
the function ‘coding-system-priority-list’ (which see) returns.
...
(fn STRING &optional HIGHEST)"
  (error ’unimplemented-error))
(defun* encode-big5-char () "Encode the Big5 character CH to BIG5 coding system.
Return the corresponding character code in Big5.

(fn CH)"
  (error ’unimplemented-error))
(defun* encode-coding-region () "Encode the current region using th specified coding system.
...
(fn START END CODING-SYSTEM &optional DESTINATION)"
  (error ’unimplemented-error))
(defun* encode-coding-string () "Encode STRING to CODING-SYSTEM, and return the result.
...
(fn STRING CODING-SYSTEM &optional NOCOPY BUFFER)"
  (error ’unimplemented-error))
(defun* encode-sjis-char () "Encode a Japanese character CH to shift_jis encoding.
Return the corresponding code in SJIS.

(fn CH)"
  (error ’unimplemented-error))
(defun* find-coding-systems-region-internal () "Internal use only.

(fn START END &optional EXCLUDE)"
  (error ’unimplemented-error))
(defun* find-operation-coding-system () "Choose a coding system for an operation based on the target name.
...
(fn OPERATION ARGUMENTS...)"
  (error ’unimplemented-error))
(defun* keyboard-coding-system () "Return coding system specified for decoding keyboard input.

(fn &optional TERMINAL)"
  (error ’unimplemented-error))
(defun* read-coding-system () "Read a coding system from the minibuffer, prompting with string PROMPT.
...
(fn PROMPT &optional DEFAULT-CODING-SYSTEM)"
  (error ’unimplemented-error))
(defun* read-non-nil-coding-system () "Read a coding system from the minibuffer, prompting with string PROMPT.

(fn PROMPT)"
  (error ’unimplemented-error))
(defun* set-coding-system-priority () "Assign higher priority to the coding systems given as arguments.
If multiple coding systems belong to the same category,
all but the first one are ignored.

(fn &rest coding-systems)"
  (error ’unimplemented-error))
(defun* set-keyboard-coding-system-internal () "Internal use only.

(fn CODING-SYSTEM &optional TERMINAL)"
  (error ’unimplemented-error))
(defun* set-safe-terminal-coding-system-internal () "Internal use only.

(fn CODING-SYSTEM)"
  (error ’unimplemented-error))
(defun* set-terminal-coding-system-internal () "Internal use only.

(fn CODING-SYSTEM &optional TERMINAL)"
  (error ’unimplemented-error))
(defun* terminal-coding-system () "Return coding system specified for terminal output on the given terminal.
TERMINAL may be a terminal object, a frame, or nil for the selected
frame’s terminal device.

(fn &optional TERMINAL)"
  (error ’unimplemented-error))
(defun* unencodable-char-position () "Return position of first un-encodable character in a region.
