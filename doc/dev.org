...
* coverage 
#+begin_src sh
/usr/lib/llvm-14/bin/llvm-profdata merge -sparse default.profraw -o default.profdata
color_run /usr/lib/llvm-14/bin/llvm-cov show ./temacs -instr-profile=default.profdata  | less -SR
#+end_src
